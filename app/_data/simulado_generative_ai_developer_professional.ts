...
export const simuladoGenerativeAiDeveloperProfessional: Simulado = {
  ...
  questions: [
  {
    ...
    "ask": "Which solution will meet these requirements with the LEAST custom development effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 3,
    "stem": "A finance company is developing an AI assistant to help clients plan investments and manage their portfolios. The company identifies several high-risk conversation patterns such as requests for specific stock recommendations or guaranteed returns. High-risk conversation patterns could lead to regulatory violations if the company cannot implement appropriate controls. The company must ensure that the AI assistant does not provide inappropriate financial advice, generate content about competitors, or make claims that are not factually grounded in the company's approved financial guidance. The company wants to use Amazon Bedrock Guardrails to implement a solution.",
  ...
  },
  {
    "id": "AIP-C01-5",
    "type": "single",
    "stem": "A company is developing an internal generative AI (GenAI) assistant that uses Amazon Bedrock to summarize corporate documents for multiple business units. The GenAI assistant must generate responses in a consistent format that includes a document summary, classification of business risks, and terms that are flagged for review. The GenAI assistant must adapt the tone of responses for each user's business unit, such as legal, human resources, or finance. The GenAI assistant must block hate speech, inappropriate topics, and sensitive information such as personal health information. The company needs a solution to centrally manage prompt variants across business units and teams. The company wants to minimize ongoing orchestration efforts and maintenance for post-processing logic. The company also wants to have the ability to adjust content moderation criteria for the GenAI assistant over time.",
    "ask": "Which solution will meet these requirements with the LEAST maintenance overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "ask": "Which additional steps must the company take to meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "ask": "Which combination of steps provides the MOST scalable solution?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-32",
    "type": "single",
    "stem": "An enterprise application uses an Amazon Bedrock foundation model (FM) to process and analyze 50 to 200 pages of technical documents. Users are experiencing inconsistent responses and receiving truncated outputs when processing documents that exceed the FM's context window limits.",
  ...
  },
  {
    "id": "AIP-C01-38",
    "type": "single",
    "stem": "A healthcare company is using Amazon Bedrock to build a system to help practitioners make clinical decisions. The system must provide treatment recommendations to physicians based only on approved medical documentation and must cite specific sources. The system must not hallucinate or produce factually incorrect information.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-39",
    "type": "single",
    "stem": "A financial services company is developing a real-time generative AI (GenAI) assistant to support human call center agents. The GenAI assistant must transcribe live customer speech, analyze context, and provide incremental suggestions to call center agents while a customer is still speaking. To preserve responsiveness, the GenAI assistant must maintain end-to-end latency under 1 second from speech to initial response display. The architecture must use only managed AWS services and must support bidirectional streaming to ensure that call center agents receive updates in real time.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-41",
    "type": "single",
    "stem": "A company has set up Amazon Q Developer Pro licenses for all developers at the company. The company maintains a list of approved resources that developers must use when developing applications. The approved resources include internal libraries, proprietary algorithmic techniques, and sample code with approved styling. A new team of developers is using Amazon Q Developer to develop a new Java-based application. The company must ensure that the new developer team uses the company's approved resources. The company does not want to make project-level modifications.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-42",
    "type": "single",
    "stem": "An ecommerce company is using Amazon Bedrock to build a customer service AI assistant. The AI assistant needs to process over 50,000 customer inquiries every day. The AI assistant occasionally experiences traffic spikes of up to 150,000 inquiries every day during promotional events. Analysis shows that 40% of inquiries follow similar patterns that share the same context. A GenAI developer must design a solution that will ensure low latency and consistent performance for the AI assistant during traffic spikes.",
  ...
  },
  {
    "id": "AIP-C01-44",
    "type": "single",
    "stem": "A company is developing a generative AI (GenAI)-powered customer support application that uses Amazon Bedrock foundation models (FMs). The application must maintain conversational context across multiple interactions with the same user. The application must run clarification workflows to handle ambiguous user queries. The company must store encrypted records of each user conversation to use for personalization. The application must be able to handle thousands of concurrent users while responding to each user quickly.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
      ...
      {
        "id": "B",
        "text": "Use an AWS Step Functions Standard workflow to orchestrate clarification workflows. Include Wait for a Callback patterns to manage the workflows. Store conversation history in Amazon DynamoDPurchase on-demand capacity and configure server-side encryption."
      },
      {
        "id": "C",
  ...
  },
  {
    "id": "AIP-C01-45",
    "type": "single",
    "stem": "A financial services company needs to pre-process unstructured data such as customer transcripts, financial reports, and documentation. The company stores the unstructured data in Amazon S3 to support an Amazon Bedrock application. The company must validate data quality, create auditable metadata, monitor data metrics, and customize text chunking to optimize foundation model (FM) performance.",
    "ask": "Which solution will meet these requirements with the LEAST development effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-51",
    "type": "single",
    "stem": "A company uses Amazon Bedrock to develop an AI assistant to provide customer support. Analysis shows that 40% of customer queries use varied phrasing or wording to ask the same questions. The company wants a solution to reduce redundant model calls. The solution must ensure that semantically equivalent questions receive consistent answers. The solution must ensure low latency.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-52",
    "type": "single",
    "stem": "A company uses AWS Lambda functions to build an AI agent solution. A GenAI developer must set up a Model Context Protocol (MCP) server that accesses user information. The GenAI developer must also configure the AI agent to use the new MCP server. The GenAI developer must ensure that only authorized users can access the MCP server.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-54",
    "type": "single",
    "stem": "A company is creating a workflow to review customer-facing communications before the company sends the communications. The company uses a pre-defined message template to generate the communications and stores the communications in an Amazon S3 bucket. The workflow needs to capture a specific portion from the template and send it to an Amazon Bedrock model. The workflow must store model responses back to the original S3 bucket.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-61",
    "type": "single",
    "stem": "A bank is developing a generative AI (GenAI)-powered AI assistant that uses Amazon Bedrock to assist the bank's website users with account inquiries and financial guidance. The bank must ensure that the AI assistant does not reveal any personally identifiable information (PII) in customer interactions. The AI assistant must not send PII in prompts to the GenAI model. The AI assistant must not respond to customer requests to provide investment advice. The bank must collect audit logs of all customer interactions, including any images or documents that are transmitted during customer interactions.",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A company deploys multiple Amazon Bedrock based generative AI (GenAI) applications across multiple business units for customer service, content generation, and document analysis. Some applications show unpredictable token consumption patterns. The company requires a comprehensive observability solution that provides real-time visibility into token usage patterns across multiple models. The observability solution must support custom dashboards for multiple stakeholder groups and provide alerting capabilities for token consumption across all the foundational models that the company's applications use.",
    "ask": "Which combination of solutions will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-68",
    "type": "single",
    "stem": "A company is planning to deploy multiple generative AI (GenAI) applications to five independent business units that operate in multiple countries in Europe and the Americas. Each application uses Amazon Bedrock Retrieval Augmented Generation (RAG) patterns with business unit-specific knowledge bases that store terabytes of unstructured data. The company must establish well-architected, standardized components for security controls, observability practices, and deployment patterns across all the GenAI applications. The components must be reusable, versioned, and governed consistently.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-70",
    "type": "single",
    "stem": "A company is developing a generative AI (GenAI) application that uses Amazon Bedrock foundation models (FMs). The application has several custom tool integrations. The application has experienced unexpected token consumption surges despite consistent user traffic. The company needs a solution that uses Amazon Bedrock model invocation logging to monitor InputTokenCount metrics and OutputTokenCount metrics. The solution must detect unusual patterns in tool usage and identify which specific tool integrations cause abnormal token consumption. The solution must also automatically adjust thresholds as traffic patterns change.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-75",
    "type": "single",
    "stem": "A company is developing a new AI-powered application that needs to integrate with various specialized tools. These tools currently run as Model Context Protocol (MCP) servers on the local machines of developers and do not maintain states between invocations. The company plans to deploy each MCP server as an AWS Lambda function to support the company's production application. The solution must be accessible to both internal applications and authorized third- party partners. The solution must use strict authentication and authorization controls.",
    "ask": "Which additional steps will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-79",
    "type": "single",
    "stem": "A company uses Amazon Bedrock to implement a Retrieval Augmented Generation (RAG)-based system to serve medical information to users. The company needs to compare multiple chunking strategies, evaluate the generation quality of two foundation models (FMs), and enforce quality thresholds for deployment.",
    "ask": "Which Amazon Bedrock evaluation configuration will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-89",
    "type": "single",
    "stem": "A company is developing a customer communication platform that uses an AI assistant powered by an Amazon Bedrock foundation model (FM). The AI assistant summarizes customer messages and generates initial response drafts. The company wants to use Amazon Comprehend to implement layered content filtering. The layered content filtering must prevent sharing of offensive content, protect customer privacy, and detect potential inappropriate advice solicitation. Inappropriate advice solicitation includes requests for unethical practices, harmful activities, or manipulative behaviors. The solution must maintain acceptable overall response times, so all pre-processing filters must finish before the content reaches the FM.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A financial services company wants to use Amazon Bedrock foundation models (FMs) to analyze call center recordings. When calls end, the call center stores recordings as MP3 files in an Amazon S3 bucket. The company needs to generate summaries and sentiment analysis for the recordings in a structured format as soon as new files are created. The recordings average 20 MB in size.",
    "ask": "Which combination of solutions will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-94",
    "type": "single",
    "stem": "A medical device company wants to feed reports of medical procedures that used the company's devices into an AI assistant. To protect patient privacy, the AI assistant must expose patient personally identifiable information (PII) only to surgeons. The AI assistant must redact PII for engineers. The AI assistant must reference only medical reports that are less than 3 years old. The company stores reports in an Amazon S3 bucket as soon as each report is published. The company has already set up an Amazon Bedrock knowledge base. The AI assistant uses Amazon Cognito to authenticate users.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-97",
    "type": "single",
    "stem": "A healthcare company is developing an application to process medical queries. The application must answer complex queries with high accuracy by reducing semantic dilution. The application must refer to domain-specific terminology in medical documents to reduce ambiguity in medical terminology. The application must be able to respond to 1,000 queries each minute with response times less than 2 seconds.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "AIP-C01-98",
    "type": "single",
    "stem": "A company has a customer service application that uses Amazon Bedrock to generate personalized responses to customer inquiries. The company needs to establish a quality assurance process to evaluate prompt effectiveness and model configurations across updates. The process must automatically compare outputs from multiple prompt templates, detect response quality issues, provide quantitative metrics, and allow human reviewers to give feedback on responses. The process must prevent configurations that do not meet a predefined quality threshold from being deployed.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Create an AWS Lambda function that sends sample customer inquiries to multiple Amazon Bedrock model configurations and stores responses in Amazon S3. Use Amazon QuickSight to visualize response patterns. Manually review outputs daily. Use AWS CodePipeline to deploy the configurations that have quality scores above the specified quality threshold."
      },
      {
        "id": "B",
        "text": "Use Amazon Bedrock evaluation jobs to compare model outputs by using custom prompt datasets. Configure AWS CodePipeline to run the evaluation jobs when prompt templates change. Configure CodePipeline to deploy the configurations that have quality scores above the specified quality threshold."
      },
      {
        "id": "C",
        "text": "Set up Amazon CloudWatch alarms to monitor response latency and error rates from Amazon Bedrock. Use Amazon EventBridge rules to notify the company when latency and error rate metrics exceed thresholds. Configure an approval workflow in AWS Systems Manager to perform manual quality checks."
      },
      {
        "id": "D",
        "text": "Use AWS Lambda functions to create an automated testing framework that samples production traffic and routes duplicate requests to the updated model version. Use Amazon Comprehend sentiment analysis to compare results. Block deployment if sentiment scores decrease."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Use an Amazon Bedrock Guardrails filter on the prompt. Set the input filter strength to HIGH."
      },
      {
        "id": "B",
        "text": "Generate multiple response variants that include the promotional message in different ways. Use a reranker model to select the most coherent version based on relevance to the original prompt."
      },
      {
        "id": "C",
        "text": "Run the prompt through Amazon Bedrock. Process the response through Amazon Bedrock Agents to add the promotional message. Rerank the results by using the original prompt and the desired message as context."
      },
      {
        "id": "D",
        "text": "Reinforce the requirement to include the new promotional message within product recommendations by using an output indicator in prompts to the FM."
      }
    ],
    "answer": [
      "D"
  ...
  },
  {
    "id": "AIP-C01-101",
    "type": "single",
    "stem": "A healthcare company is developing an AI application to retrieve medical literature to help doctors conduct research. The company wants to deploy the application to multiple countries. The application needs to index 50,000 text-heavy medical documents that contain specialized terminology in English, French, and German. The application must provide high search accuracy for medical terminology. The company wants a solution that requires minimal custom code development and ongoing maintenance.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Use Amazon Titan Text Embeddings to process all documents in their original language without translation. Apply semantic chunking at the medical section level to preserve medical terminology context and to maintain moderate vector dimensions."
      },
      {
        "id": "B",
        "text": "Use Amazon Titan Text Embeddings to translate all non-English documents to English before processing. Implement document chunking strategies based on logical sections to improve retrieval accuracy."
      },
      {
        "id": "C",
        "text": "Use Amazon Titan Multimodal Embeddings to convert document pages to images. Generate text captions for the images to create a multimodal knowledge base that handles medical content."
      },
      {
        "id": "D",
        "text": "Use an Amazon Bedrock knowledge base as the vector store. Use Amazon Kendra to perform multilingual document processing. Configure the vector store to automatically handle language detection and translation for each query."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A publishing company is developing a chat assistant that uses a containerized large language model (LLM) that runs on Amazon SageMaker AI. The architecture consists of an Amazon API Gateway REST API that routes user requests to an AWS Lambda function. The Lambda function invokes a SageMaker AI real-time endpoint that hosts the LLM. Users report uneven response times. Analytics show that a high number of chats are abandoned after 2 seconds of waiting for the first token. The company wants a solution to ensure that p95 latency is under 800 ms for interactive requests to the chat assistant.",
    "ask": "Which combination of solutions will meet this requirement?",
    "options": [
      {
        "id": "A",
        "text": "Enable model preload upon container startup. Implement dynamic batching to process multiple user requests together in a single inference pass."
      },
      {
        "id": "B",
        "text": "Select a larger GPU instance type for the SageMaker AI endpoint. Set the minimum number of instances to 0. Continue to perform per-request processing. Lazily load model weights on the first request."
      },
      {
        "id": "C",
        "text": "Switch to a multi-model endpoint. Use lazy loading without request batching."
      },
      {
        "id": "D",
        "text": "Set the minimum number of instances to greater than 0. Enable response streaming."
      },
      {
        "id": "E",
        "text": "Switch to Amazon SageMaker Asynchronous Inference for all requests. Store requests in an Amazon S3 bucket. Set the minimum number of instances to 0."
      }
    ],
    "answer": [
      "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A financial services company is developing an AI-powered search assistant application to help investment advisors quickly retrieve investment data. The application runs as an AWS Lambda function. The company is using Amazon Bedrock to develop the application by using an Amazon Bedrock knowledge base that uses Amazon OpenSearch Serverless as its data source. The application agent must manage collections at scale by automatically assigning access permissions to collections and indexes that match a specific pattern. The company uses Amazon Bedrock tools to test the knowledge base. The knowledge base sync process finishes successfully. However, the test reveals a 400 Bad Authorization error from the BedrockAgentRuntime API and a 403 Forbidden error when the test attempts to access OpenSearch Serverless. The company must resolve the permissions issues.",
    "ask": "Which combination of solutions will meet this requirement?",
    "options": [
      {
        "id": "A",
        "text": "Update the Lambda function execution role to include the bedrock:InvokeAgent permission. Add the aoss:APIAccessAll permission to the Lambda execution role."
      },
      {
        "id": "B",
        "text": "Create an OpenSearch Serverless data access policy that includes pattern- based resource rules."
      },
      {
        "id": "C",
        "text": "Configure a VPC endpoint policy for OpenSearch Serverless. Add the endpoint to the Lambda function’s VPC configuration."
      },
      {
        "id": "D",
        "text": "Configure AWS Secrets Manager to store OpenSearch Serverless credentials. Grant the Lambda function access to retrieve the credentials."
      },
      {
        "id": "E",
        "text": "Enable IAM authentication for the OpenSearch Serverless domain. Add the es:ESHttp* permission to the Lambda function execution role."
      }
    ],
    "answer": [
      "A",
  ...
  },
  {
    "id": "AIP-C01-105",
    "type": "single",
    "stem": "A financial services company is developing a GenAI application that allows business analysts to query sensitive customer data by using natural language. A GenAI developer must implement a content safety framework that performs text-to-SQL transformations while preventing harmful outputs. The solution must detect and block SQL injection attempts in natural language prompts, validate generated SQL queries against predefined schemas, and create an audit trail of query transformations.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Use Amazon Bedrock with an integrated content filtering system. Deploy Amazon GuardDuty with custom SQL threat detection rules. Use AWS Lambda functions to check generated queries against schema definitions in AWS Systems Manager Parameter Store. Use Amazon EventBridge to store records of all transformations in Amazon S3."
      },
      {
        "id": "B",
        "text": "Implement a multi-stage validation pipeline that uses Amazon Bedrock Guardrails to filter inputs. Configure AWS Lambda functions to use with SQL parsing libraries to validate query syntax. Use the Amazon RDS Data API to verify queries against defined schemas and collect audit logs before the pipeline runs each query."
      },
      {
        "id": "C",
        "text": "Configure AWS CloudTrail to log all database API calls. Implement IAM roles that have least privilege access to the application. Use AWS WAF to filter malicious inputs to the application."
      },
      {
        "id": "D",
        "text": "Train a custom Amazon SageMaker AI model to securely transform text to SQL. Attach VPC endpoints to isolate the customer data database. Store query history in Amazon DynamoDB."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    "id": "AIP-C01-107",
    "type": "single",
    "stem": "A healthcare company wants to develop a proof-of-concept application that uses Amazon Bedrock to automatically summarize medical documents. The company has 3 weeks to validate the application’s accuracy. The application must comply with the company’s data privacy policies. The application must include metrics to evaluate summarization accuracy and processing time.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Create a dataset that includes 50-100 anonymized patient records. Implement Retrieval Augmented Generation (RAG) with a secure knowledge base. Use a judge model to evaluate accuracy metrics across three foundation models (FMs)."
      },
      {
        "id": "B",
        "text": "Fine-tune a single foundation model (FM) on patient records. Deploy the FM on Amazon Bedrock. Use Amazon Bedrock AgentCore to configure the FM as an agent. Conduct user testing on 500 company staff members."
      },
      {
        "id": "C",
        "text": "Select the most powerful available AWS foundation model (FM). Create a chat interface by using Converse APIs. Test the application on 50-100 actual patient records by using only qualitative feedback from stakeholders. Use a custom web interface to gather real-world performance metrics."
      },
      {
        "id": "D",
        "text": "Use the Strands SDK to deploy multiple agents that connect to multiple knowledge bases that contain specialized medical documents. Compare the responses of the agents. Evaluate the integration of the agents with the company’s existing systems."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    "id": "AIP-C01-108",
    "type": "single",
    "stem": "A company wants to select a new FM for its AI assistant. A GenAI developer needs to generate evaluation reports to help a data scientist assess the quality and safety of various foundation models (FMs). The data scientist provides the GenAI developer with sample prompts for evaluation. The GenAI developer wants to use Amazon Bedrock to automate report generation and evaluation.",
    "ask": "Which solution will meet this requirement?",
    "options": [
      {
        "id": "A",
        "text": "Combine the sample prompts into a single JSON document. Create an Amazon Bedrock knowledge base with the document. Write a prompt that asks the FM to generate a response to each sample prompt. Use the RetrieveAndGenerate API to generate a report for each model."
      },
      {
        "id": "B",
        "text": "Combine the sample prompts into a single JSONL document. Store the document in an Amazon S3 bucket. Create an Amazon Bedrock evaluation job that uses a judge model. Specify the S3 location as input and a different S3 location as output. Run an evaluation job for each FM and select the FM as the generator."
      },
      {
        "id": "C",
        "text": "Combine the sample prompts into a single JSONL document. Store the document in an Amazon S3 bucket. Create an Amazon Bedrock evaluation job that uses a judge model. Specify the S3 location as input and Amazon Quick Sight as output. Run an evaluation job for each FM and select the FM as the evaluator."
      },
      {
        "id": "D",
        "text": "Combine the sample prompts into a single JSON document. Create an Amazon Bedrock knowledge base from the document. Create an Amazon Bedrock evaluation job that uses the retrieval and response generation evaluation type. Specify an Amazon S3 bucket as the output. Run an evaluation job for each FM."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    "id": "AIP-C01-109",
    "type": "single",
    "stem": "A financial services company is developing a natural language processing (NLP) application that uses an AWS Lambda function to process customer trade inquiries by using Amazon Bedrock foundation models (FMs). The Lambda function must generate comprehensive trade analysis responses that typically exceed 4 MB and require 15-20 seconds to complete. The application must respond to customer inquiries in less than 10 seconds and comply with financial regulatory requirements to retain records for 10 years.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Implement response streaming to display partial responses as the application generates them. Set a 15-second timeout for Lambda function execution time. Enable AWS X-Ray tracing to monitor performance."
      },
      {
        "id": "B",
        "text": "Use Amazon SQS queues to implement asynchronous invocations. Set a 30- second timeout for Lambda function execution time. Use Amazon CloudWatch to monitor response times."
      },
      {
        "id": "C",
        "text": "Use Amazon API Gateway to poll the application. Integrate the application with Amazon ElastiCache to cache responses. Set a 30-second timeout for Lambda function execution time. Collect detailed Amazon CloudWatch logs for application performance."
      },
      {
        "id": "D",
        "text": "Implement response streaming to display partial responses as the application generates them. Set a 30-second timeout for Lambda function execution time. Store complete response records in Amazon S3."
      }
    ],
    "answer": [
      "D"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Use Step Functions Map states to run agent workflows in parallel. Pass updated secret metadata through Lambda function outputs. Use AWS AppConfig to version all prompt flows to gate and roll back faulty templates."
      },
      {
        "id": "B",
        "text": "Use Amazon Bedrock AgentCore only. Configure Amazon Bedrock guardrails to restrict prompt variation. Use an inline JSON schema for a single agent’s workflow definition to chain tool calls."
      },
      {
        "id": "C",
        "text": "Use a centralized Amazon EventBridge pipeline to invoke each event agent. Store intermediate prompts in Amazon DynamoDB. Resolve agent ordering by using TTL-based backoff and retries."
      },
      {
        "id": "D",
        "text": "Use Amazon EventBridge Pipes to invoke resolvers based on Amazon CloudWatch log patterns. Store response metadata in Amazon DynamoDB. Configure a TTL and versioned writes. Use Amazon Q Developer to dynamically generate fallback prompts that are routed through a Lambda coordinator."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    "id": "AIP-C01-112",
    "type": "single",
    "stem": "A financial services company processes more than 10,000 customer inquiries every day through a multi-agent GenAI application that uses Amazon Bedrock AgentCore. The application agents invoke several custom tools. During peak usage periods, users report that the custom tools experience up to 40% failure rates. The tools perform inconsistently for different teams at the company. A GenAI developer must implement an observability solution that provides end-to-end visibility into agent interactions and tool behavior. The solution must use built-in Amazon Bedrock capabilities and must not require custom instrumentation. The GenAI developer needs a solution that requires minimal performance overhead.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Enable AgentCore Observability and trace collection. Use AWS X-Ray to capture distributed traces for the custom tools. Build Amazon CloudWatch dashboards to visualize metrics for errors, throttling, and latency during peak usage periods."
      },
      {
        "id": "B",
        "text": "Use Amazon CloudWatch Container Insights to monitor the agents. Configure an AWS Lambda function to poll the Amazon Bedrock API for tool usage metrics. Configure the function to store results in CloudWatch to generate alerts."
      },
      {
        "id": "C",
        "text": "Build a custom ETL pipeline that uses AWS Lambda functions to process Amazon CloudWatch logs from Amazon Bedrock. Store the processed data in Amazon DynamoDB. Use Amazon Quick Sight to visualize cross-team performance patterns."
      },
      {
        "id": "D",
        "text": "Enable AgentCore Observability and send trace data to Amazon CloudWatch Logs. Use a custom AWS Lambda function to extract tool performance metrics from the logs. Use Amazon Managed Grafana to visualize trends."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "An ecommerce company is using an Anthropic Claude Sonnet model in Amazon Bedrock to generate product recommendations. An AWS Lambda function retrieves customer purchase data from Amazon DynamoDB, product reviews from Amazon S3, and customer profile information from Amazon RDS. Then the function sends the data directly to the Amazon Bedrock model through API calls. Recently, customers who have extensive purchase histories have begun to receive incomplete recommendations. Amazon CloudWatch logs for the Lambda function show execution timeouts. CloudWatch logs for Amazon Bedrock API calls show intermittent errors. The company reviews the logs and finds that some requests are failing with context length exceeded errors. Other requests finish but appear to ignore portions of the input data. The company wants the recommendation system to consider all customer data when the system generates recommendations. The company wants to use Amazon Bedrock Knowledge Bases to improve data organization and retrieval.",
    "ask": "Which combination of solutions will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Implement a chunking strategy that divides the customer data into smaller segments. Configure the model to process each segment separately. Invoke the model a final time to synthesize the individual responses into comprehensive recommendations."
      },
      {
        "id": "B",
        "text": "Modify the prompt structure to place the most critical information at the beginning and end of the context window. Implement token-counting logic to truncate less important data when the interaction approaches the model’s maximum context length."
      },
      {
        "id": "C",
        "text": "Replace Claude Sonnet with a model that has a larger context window capacity. Increase the Lambda function timeout to accommodate longer processing times for larger inputs."
      },
      {
        "id": "D",
        "text": "Configure the recommendation system to use the Converse API. Modify the additionalModelRequestFields parameter to increase the maximum token limit beyond the model’s default context window size."
      },
      {
        "id": "E",
        "text": "Implement RAG by using a knowledge base to index the customer data with vector embeddings. Retrieve only the most semantically relevant information for each recommendation request based on the current customer context."
      }
    ],
    "answer": [
      "A",
  ...
  },
  {
    "id": "AIP-C01-114",
    "type": "single",
    "stem": "A company developed a multimodal content analysis application by using Amazon Bedrock. The application routes different content types (text, images, and code) to specialized foundation models (FMs). The application needs to handle multiple types of routing decisions. Simple routing based on file extension must have minimal latency. Complex routing based on content semantics requires analysis before FM selection. The application must provide detailed history and support fallback options when primary FMs fail.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Configure AWS Lambda functions that call Amazon Bedrock FMs for all routing logic. Use conditional statements to determine the appropriate FM based on content type and semantics."
      },
      {
        "id": "B",
        "text": "Create a hybrid solution. Handle simple routing based on file extensions in application code. Handle complex content-based routing by using an AWS Step Functions state machine with JSONata for content analysis and the InvokeModel API for specialized FMs."
      },
      {
        "id": "C",
        "text": "Deploy separate AWS Step Functions workflows for each content type with routing logic in AWS Lambda functions. Use Amazon EventBridge to coordinate between workflows when fallback to alternate FMs is required."
      },
      {
        "id": "D",
        "text": "Use Amazon SQS with different SQS queues for each content type. Configure AWS Lambda consumers that analyze content and invoke appropriate FMs based on message attributes by using Amazon Bedrock with an AWS SDK."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    "id": "AIP-C01-115",
    "type": "single",
    "stem": "A company is developing a customer support chat assistant that uses an Amazon Bedrock foundation model (FM). The company wants to update to a newer FM version but needs to implement a validation system to detect semantic drift in responses. The company wants to ensure that performance and functionality for end users remains consistent. The company needs a solution to compare responses between current and new FM versions for 500 test cases. The solution must detect changes in response meaning, generate quantitative similarity scores, complete validations, and log detailed results for historical comparison.",
    "ask": "Which solution will meet these requirements with the LEAST operational complexity?",
    "options": [
      {
        "id": "A",
        "text": "Configure Amazon CloudWatch Synthetics canaries that use custom JavaScript code to send identical prompts to both new and existing FM versions. Store responses in Amazon S3. Perform manual reviews to identify semantic differences between FM versions."
      },
      {
        "id": "B",
        "text": "Configure an AWS Step Functions workflow that sends test prompts to both new and existing FM versions. Use Amazon Bedrock embedding models to calculate cosine similarity scores. Store the results in Amazon DynamoDB with a composite key schema."
      },
      {
        "id": "C",
        "text": "Use Amazon Bedrock model evaluation jobs to compare the new FM version against the current version using the 500 test cases. Configure the evaluation to calculate semantic similarity metrics. Store results in Amazon S3 for historical comparison."
      },
      {
        "id": "D",
        "text": "Build a custom solution by using Amazon SageMaker AI to train a classifier model on historical responses to detect anomalies when the solution compares responses from the new FM version to previous patterns."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    "id": "AIP-C01-116",
    "type": "single",
    "stem": "A media company is building an AI-powered content moderation system by using Amazon Bedrock. The system first classifies text by using a small, low-latency model. Then the system escalates requests that have a confidence score below 0.65 to a larger, more expensive model. The system must respond in near real time for high-confidence results. The system must process low-confidence requests asynchronously. The system must scale to meet sudden spikes in demand. The company wants to optimize costs for the system by invoking the larger model only when required. The company wants to use decoupled components to achieve high resiliency for the system.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Use Amazon API Gateway to invoke the small model synchronously. If the small model’s confidence score is below 0.65, synchronously call the larger model. Use provisioned concurrency to handle traffic spikes."
      },
      {
        "id": "B",
        "text": "Use an AWS Step Functions workflow that has parallel branches to run both the small model and the large model for every request. Choose the large model result when confidence score values differ."
      },
      {
        "id": "C",
        "text": "Send requests to an Amazon SQS queue. Use AWS Fargate to process messages. Invoke the small model first. If the confidence score is below 0.65, place the request in a second SQS queue to process asynchronously by using the large model."
      },
      {
        "id": "D",
        "text": "Deploy both models on Amazon EC2 instances and enable auto scaling. Use a custom application heuristic to route requests to the appropriate instance based on phrase length and keyword rules."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    "id": "AIP-C01-117",
    "type": "single",
    "stem": "A social messaging company is building an AI chat assistant by using Amazon Bedrock. The company must ensure that every inference complies with an approved safety policy. The company wants to block harmful prompts before model invocations, filter streamed model outputs in real time, and route flagged cases for human review.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Configure an AWS Step Functions workflow. Configure a step to use an AWS Lambda function to pre-check inputs by using the ApplyGuardrail API. Use an InvokeModelWithResponseStream API step that has the guardrail attached. Configure a second Lambda function step to post-check outputs by using the ApplyGuardrail API. Route flagged items to an Amazon SQS queue. Enforce guardrail use by using a bedrock:GuardrailIdentifier IAM condition."
      },
      {
        "id": "B",
        "text": "Configure an AWS Step Functions workflow. Configure a step to call the ApplyGuardrail API before inference. Then call the InvokeModel API without streaming and use the guardrail. Store the results in Amazon S3. Use the client UI to hide problematic tokens."
      },
      {
        "id": "C",
        "text": "Configure an AWS Step Functions workflow. Configure a step to use the InvokeModelWithResponseStream API that has the guardrail attached for in- stream filtering. Run an AWS Lambda post-check step by using the ApplyGuardrail API to check flagged cases. Do not perform pre-inference."
      },
      {
        "id": "D",
        "text": "Configure an AWS Step Functions workflow that includes steps to perform pre-checks and post-checks by using the ApplyGuardrail API and the InvokeModelWithResponseStream API. Attach the guardrail to the check steps. Use process controls such as code reviews instead of IAM enforcement to ensure that guardrails are always applied."
      }
    ],
    "answer": [
      "A"
