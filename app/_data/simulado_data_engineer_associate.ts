...
export const simuladoDataEngineerAssociate: Simulado = {
  ...
  },
  {
    "id": "DEA-C01-2",
    "type": "single",
    "stem": "A retail company has a customer data hub in an Amazon S3 bucket. Employees from many countries use the data hub to support company-wide analytics. A governance team must ensure that the company's data analysts can access data only for customers who are within the same country as the analysts.",
  ...
  },
  {
    "id": "DEA-C01-3",
    "type": "single",
    "stem": "A media company wants to improve a system that recommends media content to customers based on user behavior and preferences. To improve the recommendation system, the company needs to incorporate insights from third-party datasets into the company's existing analytics platform. The company wants to minimize the effort and time required to incorporate third-party datasets.",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A financial company wants to implement a data mesh. The data mesh must support centralized data governance, data analysis, and data access control. The company has decided to use AWS Glue for data catalogs and extract, transform, and load (ETL) operations.",
    "ask": "Which combination of AWS services will implement a data mesh?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-6",
    "type": "single",
    "stem": "A company created an extract, transform, and load (ETL) data pipeline in AWS Glue. A data engineer must crawl a table that is in Microsoft SQL Server. The data engineer needs to extract, transform, and load the output of the crawl to an Amazon S3 bucket. The data engineer also must orchestrate the data pipeline.",
    "ask": "Which AWS service or feature will meet these requirements MOST cost-effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-7",
    "type": "single",
    "stem": "A financial services company stores financial data in Amazon Redshift. A data engineer wants to run real-time queries on the financial data to support a web-based trading application. The data engineer wants to run the queries from within the trading application.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-8",
    "type": "single",
    "stem": "A company uses Amazon Athena for one-time queries against data that is in Amazon S3. The company has several use cases. The company must implement permission controls to separate query processes and access to query history among users, teams, and applications that are in the same AWS account.",
  ...
  },
  {
    "id": "DEA-C01-9",
    "type": "single",
    "stem": "A data engineer needs to schedule a workflow that runs a set of AWS Glue jobs every day. The data engineer does not require the Glue jobs to run or finish at a specific time.",
    "ask": "Which solution will run the Glue jobs in the MOST cost-effective way?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-10",
    "type": "single",
    "stem": "A data engineer needs to create an AWS Lambda function that converts the format of data from .csv to Apache Parquet. The Lambda function must run only if a user uploads a .csv file to an Amazon S3 bucket.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-11",
    "type": "single",
    "stem": "A data engineer needs Amazon Athena queries to finish faster. The data engineer notices that all the files the Athena queries use are currently stored in uncompressed .csv format. The data engineer also notices that users perform most queries by selecting a specific column.",
    "ask": "Which solution will MOST speed up the Athena query performance?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-13",
    "type": "single",
    "stem": "A company stores daily records of the financial performance of investment portfolios in .csv format in an Amazon S3 bucket. A data engineer uses AWS Glue crawlers to crawl the S3 data. The data engineer must make the S3 data accessible daily in the AWS Glue Data Catalog.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-15",
    "type": "single",
    "stem": "A data engineer needs to securely transfer 5 TB of data from an on-premises data center to an Amazon S3 bucket. Approximately 5% of the data changes every day. Updates to the data need to be regularly proliferated to the S3 bucket. The data includes files that are in multiple formats. The data engineer needs to automate the transfer process and must schedule the process to run periodically.",
    "ask": "Which AWS service should the data engineer use to transfer the data in the MOST operationally efficient way?",
    "options": [
      {
        "id": "A",
        "text": "AWS DataSync"
  ...
  },
  {
    "id": "DEA-C01-16",
    "type": "single",
    "stem": "A company uses an on-premises Microsoft SQL Server database to store financial transaction data. The company migrates the transaction data from the on-premises database to AWS at the end of each month. The company has noticed that the cost to migrate data from the on-premises database to an Amazon RDS for SQL Server database has increased recently. The company requires a cost-effective solution to migrate the data to AWS. The solution must cause minimal downtime for the applications that access the database.",
    "ask": "Which AWS service should the company use to meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "AWS Lambda"
  ...
  },
  {
    ...
    "ask": "Which combination of tasks will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-18",
    "type": "single",
    "stem": "A company uses an Amazon Redshift cluster that runs on RA3 nodes. The company wants to scale read and write capacity to meet demand. A data engineer needs to identify a solution that will turn on concurrency scaling.",
    "ask": "Which solution will meet this requirement?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A data engineer must orchestrate a series of Amazon Athena queries that will run every day. Each query can run for more than 15 minutes.",
    "ask": "Which combination of steps will meet these requirements MOST cost-effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "ask": "Which extract, transform, and load (ETL) service will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "AWS Glue"
  ...
  },
  {
    "id": "DEA-C01-21",
    "type": "single",
    "stem": "A data engineer must use AWS services to ingest a dataset into an Amazon S3 data lake. The data engineer profiles the dataset and discovers that the dataset contains personally identifiable information (PII). The data engineer must implement a solution to profile the dataset and obfuscate the PII.",
    "ask": "Which solution will meet this requirement with the LEAST operational effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-25",
    "type": "single",
    "stem": "A data engineer needs to join data from multiple sources to perform a one-time analysis job. The data is stored in Amazon DynamoDB, Amazon RDS, Amazon Redshift, and Amazon S3.",
    "ask": "Which solution will meet this requirement MOST cost-effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A company is planning to use a provisioned Amazon EMR cluster that runs Apache Spark jobs to perform big data analysis. The company requires high reliability. A big data team must follow best practices for running cost-optimized and long-running workloads on Amazon EMR. The team must find a solution that will maintain the company's current level of performance.",
    "ask": "Which combination of resources will meet these requirements MOST cost-effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-27",
    "type": "single",
    "stem": "A company wants to implement real-time analytics capabilities. The company wants to use Amazon Kinesis Data Streams and Amazon Redshift to ingest and process streaming data at the rate of several gigabytes per second. The company wants to derive near real-time insights by using existing business intelligence (BI) and analytics tools.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A company uses an Amazon QuickSight dashboard to monitor usage of one of the company's applications. The company uses AWS Glue jobs to process data for the dashboard. The company stores the data in a single Amazon S3 bucket. The company adds new data every day. A data engineer discovers that dashboard queries are becoming slower over time. The data engineer determines that the root cause of the slowing queries is long-running AWS Glue jobs.",
    "ask": "Which actions should the data engineer take to improve the performance of the AWS Glue jobs?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-29",
    "type": "single",
    "stem": "A data engineer needs to use AWS Step Functions to design an orchestration workflow. The workflow must parallel process a large collection of data files and apply a specific transformation to each file.",
    "ask": "Which Step Functions state should the data engineer use to meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Parallel state"
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A company is building an analytics solution. The solution uses Amazon S3 for data lake storage and Amazon Redshift for a data warehouse. The company wants to use Amazon Redshift Spectrum to query the data that is in Amazon S3.",
    "ask": "Which actions will provide the FASTEST queries?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-33",
    "type": "single",
    "stem": "A company has a frontend ReactJS website that uses Amazon API Gateway to invoke REST APIs. The APIs perform the functionality of the website. A data engineer needs to write a Python script that can be occasionally invoked through API Gateway. The code must return results to API Gateway.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A data engineer runs Amazon Athena queries on data that is in an Amazon S3 bucket. The Athena queries use AWS Glue Data Catalog as a metadata table. The data engineer notices that the Athena query plans are experiencing a performance bottleneck. The data engineer determines that the cause of the performance bottleneck is the large number of partitions that are in the S3 bucket. The data engineer must resolve the performance bottleneck and reduce Athena query planning time.",
  ...
  },
  {
    "id": "DEA-C01-38",
    "type": "single",
    "stem": "A company is planning to upgrade its Amazon Elastic Block Store (Amazon EBS) General Purpose SSD storage from gp2 to gp3. The company wants to prevent any interruptions in its Amazon EC2 instances that will cause data loss during the migration to the upgraded storage.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-40",
    "type": "single",
    "stem": "A data engineering team is using an Amazon Redshift data warehouse for operational reporting. The team wants to prevent performance issues that might result from long-running queries. A data engineer must choose a system table in Amazon Redshift to record anomalies when a query optimizer identifies conditions that might indicate performance issues.",
    "ask": "Which table views should the data engineer use to meet this requirement?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-41",
    "type": "single",
    "stem": "A data engineer must ingest a source of structured data that is in .csv format into an Amazon S3 data lake. The .csv files contain 15 columns. Data analysts need to run Amazon Athena queries on one or two columns of the dataset. The data analysts rarely query the entire file.",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A company uses AWS Step Functions to orchestrate a data pipeline. The pipeline consists of Amazon EMR jobs that ingest data from data sources and store the data in an Amazon S3 bucket. The pipeline also includes EMR jobs that load the data to Amazon Redshift. The company's cloud infrastructure team manually built a Step Functions state machine. The cloud infrastructure team launched an EMR cluster into a VPC to support the EMR jobs. However, the deployed Step Functions state machine is not able to run the EMR jobs.",
    "ask": "Which combination of steps should the company take to identify the reason the Step Functions state machine is not able to run the EMR jobs?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-45",
    "type": "single",
    "stem": "A company uses Amazon Athena to run SQL queries for extract, transform, and load (ETL) tasks by using Create Table As Select (CTAS). The company must use Apache Spark instead of SQL to generate analytics.",
    "ask": "Which solution will give the company the ability to use Spark to access Athena?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-46",
    "type": "single",
    "stem": "A company needs to partition the Amazon S3 storage that the company uses for a data lake. The partitioning will use a path of the S3 object keys in the following format: s3://bucket/prefix/year=2023/month=01/day=01. A data engineer must ensure that the AWS Glue Data Catalog synchronizes with the S3 storage when the company adds new partitions to the bucket.",
    "ask": "Which solution will meet these requirements with the LEAST latency?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-47",
    "type": "single",
    "stem": "A media company uses software as a service (SaaS) applications to gather data by using third-party tools. The company needs to store the data in an Amazon S3 bucket. The company will use Amazon Redshift to perform analytics based on the data.",
    "ask": "Which AWS service or feature will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-49",
    "type": "single",
    "stem": "A data engineer has a one-time task to read data from objects that are in Apache Parquet format in an Amazon S3 bucket. The data engineer needs to query only one column of the data.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-50",
    "type": "single",
    "stem": "A company uses Amazon Redshift for its data warehouse. The company must automate refresh schedules for Amazon Redshift materialized views.",
    "ask": "Which solution will meet this requirement with the LEAST effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-51",
    "type": "single",
    "stem": "A data engineer must orchestrate a data pipeline that consists of one AWS Lambda function and one AWS Glue job. The solution must integrate with AWS services.",
  ...
  },
  {
    "id": "DEA-C01-54",
    "type": "single",
    "stem": "A company is planning to migrate on-premises Apache Hadoop clusters to Amazon EMR. The company also needs to migrate a data catalog into a persistent storage solution. The company currently stores the data catalog in an on-premises Apache Hive metastore on the Hadoop clusters. The company requires a serverless solution to migrate the data catalog.",
    "ask": "Which solution will meet these requirements MOST cost-effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-56",
    "type": "single",
    "stem": "A security company stores IoT data that is in JSON format in an Amazon S3 bucket. The data structure can change when the company upgrades the IoT devices. The company wants to create a data catalog that includes the IoT data. The company's analytics department will use the data catalog to index the data.",
    "ask": "Which solution will meet these requirements MOST cost-effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-57",
    "type": "single",
    "stem": "A company stores details about transactions in an Amazon S3 bucket. The company wants to log all writes to the S3 bucket into another S3 bucket that is in the same AWS Region.",
    "ask": "Which solution will meet this requirement with the LEAST operational effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-58",
    "type": "single",
    "stem": "A data engineer needs to maintain a central metadata repository that users access through Amazon EMR and Amazon Athena queries. The repository needs to provide the schema and properties of many tables. Some of the metadata is stored in Apache Hive. The data engineer needs to import the metadata from Hive into the central metadata repository.",
  ...
  },
  {
    "id": "DEA-C01-59",
    "type": "single",
    "stem": "A company needs to build a data lake in AWS. The company must provide row-level data access and column-level data access to specific teams. The teams will access the data by using Amazon Athena, Amazon Redshift Spectrum, and Apache Hive from Amazon EMR.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-62",
    "type": "single",
    "stem": "A company has used an Amazon Redshift table that is named Orders for 6 months. The company performs weekly updates and deletes on the table. The table has an interleaved sort key on a column that contains AWS Regions. The company wants to reclaim disk space so that the company will not run out of storage space. The company also wants to analyze the sort key column.",
    "ask": "Which Amazon Redshift command will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-64",
    "type": "single",
    "stem": "A company stores data in a data lake that is in Amazon S3. Some data that the company stores in the data lake contains personally identifiable information (PII). Multiple user groups need to access the raw data. The company must ensure that user groups can access only the PII that they require.",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A data engineer must build an extract, transform, and load (ETL) pipeline to process and load data from 10 source systems into 10 tables that are in an Amazon Redshift database. All the source systems generate .csv, JSON, or Apache Parquet files every 15 minutes. The source systems all deliver files into one Amazon S3 bucket. The file sizes range from 10 MB to 20 GB. The ETL pipeline must function correctly despite changes to the data schema.",
    "ask": "Which data pipeline solutions will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-68",
    "type": "single",
    "stem": "A company receives .csv files that contain physical address data. The data is in columns that have the following names: Door_No, Street_Name, City, and Zip_Code. The company wants to create a single column to store these values in the following JSON format: { \"Door_No\": \"24\", \"Street_Name\": \"AAA street\", \"City\": \"BBB\", \"Zip_Code\": \"111111\" }.",
    "ask": "Which solution will meet this requirement with the LEAST coding effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-69",
    "type": "single",
    "stem": "A company receives call logs as Amazon S3 objects that contain sensitive customer information. The company must protect the S3 objects by using encryption. The company must also use encryption keys that only specific employees can access.",
    "ask": "Which solution will meet these requirements with the LEAST effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "During a security review, a company identified a vulnerability in an AWS Glue job. The company discovered that credentials to access an Amazon Redshift cluster were hard coded in the job script. A data engineer must remediate the security vulnerability in the AWS Glue job. The solution must securely store the credentials.",
    "ask": "Which combination of steps should the data engineer take to meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-74",
    "type": "single",
    "stem": "A healthcare company uses Amazon Kinesis Data Streams to stream real-time health data from wearable devices, hospital equipment, and patient records. A data engineer needs to find a solution to process the streaming data. The data engineer needs to store the data in an Amazon Redshift Serverless warehouse. The solution must support near real-time analytics of the streaming data and the previous day's data.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A data engineer needs to use an Amazon QuickSight dashboard that is based on Amazon Athena queries on data that is stored in an Amazon S3 bucket. When the data engineer connects to the QuickSight dashboard, the data engineer receives an error message that indicates insufficient permissions.",
    "ask": "Which factors could cause the permissions-related errors?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-76",
    "type": "single",
    "stem": "A company stores datasets in JSON format and .csv format in an Amazon S3 bucket. The company has Amazon RDS for Microsoft SQL Server databases, Amazon DynamoDB tables that are in provisioned capacity mode, and an Amazon Redshift cluster. A data engineering team must develop a solution that will give data scientists the ability to query all data sources by using syntax similar to SQL.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-77",
    "type": "single",
    "stem": "A data engineer is configuring Amazon SageMaker Studio to use AWS Glue interactive sessions to prepare data for machine learning (ML) models. The data engineer receives an access denied error when the data engineer tries to prepare the data by using SageMaker Studio.",
    "ask": "Which change should the engineer make to gain access to SageMaker Studio?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-79",
    "type": "single",
    "stem": "A company has multiple applications that use datasets that are stored in an Amazon S3 bucket. The company has an ecommerce application that generates a dataset that contains personally identifiable information (PII). The company has an internal analytics application that does not require access to the PII. To comply with regulations, the company must not share PII unnecessarily. A data engineer needs to implement a solution that will redact PII dynamically, based on the needs of each application that accesses the dataset.",
    "ask": "Which solution will meet the requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-80",
    "type": "single",
    "stem": "A data engineer needs to build an extract, transform, and load (ETL) job. The ETL job will process daily incoming .csv files that users upload to an Amazon S3 bucket. The size of each S3 object is less than 100 MB.",
    "ask": "Which solution will meet these requirements MOST cost-effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-81",
    "type": "single",
    "stem": "A data engineer creates an AWS Glue Data Catalog table by using an AWS Glue crawler that is named Orders. The data engineer wants to add the following new partitions: s3://transactions/orders/order_date=2023-01-01 and s3://transactions/orders/order_date=2023-01-02. The data engineer must edit the metadata to include the new partitions in the table without scanning all the folders and files in the location of the table.",
    "ask": "Which data definition language (DDL) statement should the data engineer use in Amazon Athena?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-82",
    "type": "single",
    "stem": "A company stores 10 to 15 TB of uncompressed .csv files in Amazon S3. The company is evaluating Amazon Athena as a one-time query engine. The company wants to transform the data to optimize query runtime and storage costs.",
    "ask": "Which file format and compression solution will meet these requirements for Athena queries?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-83",
    "type": "single",
    "stem": "A company uses Apache Airflow to orchestrate the company's current on-premises data pipelines. The company runs SQL data quality check tasks as part of the pipelines. The company wants to migrate the pipelines to AWS and to use AWS managed services.",
    "ask": "Which solution will meet these requirements with the LEAST amount of refactoring?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-84",
    "type": "single",
    "stem": "A company uses Amazon EMR as an extract, transform, and load (ETL) pipeline to transform data that comes from multiple sources. A data engineer must orchestrate the pipeline to maximize performance.",
    "ask": "Which AWS service will meet this requirement MOST cost effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-86",
    "type": "single",
    "stem": "A company has a business intelligence platform on AWS. The company uses an AWS Storage Gateway Amazon S3 File Gateway to transfer files from the company's on-premises environment to an Amazon S3 bucket. A data engineer needs to setup a process that will automatically launch an AWS Glue workflow to run a series of AWS Glue jobs when each file transfer finishes successfully.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-88",
    "type": "single",
    "stem": "A manufacturing company has many IoT devices in facilities around the world. The company uses Amazon Kinesis Data Streams to collect data from the devices. The data includes device ID, capture date, measurement type, measurement value, and facility ID. The company uses facility ID as the partition key. The company's operations team recently observed many WriteThroughputExceeded exceptions. The operations team found that some shards were heavily used but other shards were generally idle.",
    "ask": "How should the company resolve the issues that the operations team observed?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-89",
    "type": "single",
    "stem": "A data engineer wants to improve the performance of SQL queries in Amazon Athena that run against a sales data table. The data engineer wants to understand the execution plan of a specific SQL statement. The data engineer also wants to see the computational cost of each operation in a SQL query.",
    "ask": "Which statement does the data engineer need to run to meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-90",
    "type": "single",
    "stem": "A company plans to provision a log delivery stream within a VPC. The company configured the VPC flow logs to publish to Amazon CloudWatch Logs. The company needs to send the flow logs to Splunk in near real time for further analysis.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-92",
    "type": "single",
    "stem": "A company has developed several AWS Glue extract, transform, and load (ETL) jobs to validate and transform data from Amazon S3. The ETL jobs load the data into Amazon RDS for MySQL in batches once every day. The ETL jobs use a DynamicFrame to read the S3 data. The ETL jobs currently process all the data that is in the S3 bucket. However, the company wants the jobs to process only the daily incremental data.",
    "ask": "Which solution will meet this requirement with the LEAST coding effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-93",
    "type": "single",
    "stem": "An online retail company has an application that runs on Amazon EC2 instances that are in a VPC. The company wants to collect flow logs for the VPC and analyze network traffic.",
    "ask": "Which solution will meet these requirements MOST cost-effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-95",
    "type": "single",
    "stem": "A company has a data warehouse that contains a table that is named Sales. The company stores the table in Amazon Redshift. The table includes a column that is named city_name. The company wants to query the table to find all rows that have a city_name that starts with \"San\" or \"El\".",
    "ask": "Which SQL query will meet this requirement?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-97",
    "type": "single",
    "stem": "A lab uses IoT sensors to monitor humidity, temperature, and pressure for a project. The sensors send 100 KB of data every 10 seconds. A downstream process will read the data from an Amazon S3 bucket every 30 seconds.",
    "ask": "Which solution will deliver the data to the S3 bucket with the LEAST latency?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A company wants to use machine learning (ML) to perform analytics on data that is in an Amazon S3 data lake. The company has two data transformation requirements that will give consumers within the company the ability to create reports. The company must perform daily transformations on 300 GB of data that is in a variety of formats that must arrive in Amazon S3 at a scheduled time. The company must perform one-time transformations of terabytes of archived data that is in the S3 data lake. The company uses Amazon Managed Workflows for Apache Airflow (Amazon MWAA) Directed Acyclic Graphs (DAGs) to orchestrate processing.",
    "ask": "Which combination of tasks should the company schedule in the Amazon MWAA DAGs to meet these requirements MOST cost-effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-99",
    "type": "single",
    "stem": "A retail company uses AWS Glue for extract, transform, and load (ETL) operations on a dataset that contains information about customer orders. The company wants to implement specific validation rules to ensure data accuracy and consistency.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-100",
    "type": "single",
    "stem": "An insurance company stores transaction data that the company compressed with gzip. The company needs to query the transaction data for occasional audits.",
  ...
  },
  {
    "id": "DEA-C01-101",
    "type": "single",
    "stem": "A data engineer finished testing an Amazon Redshift stored procedure that processes and inserts data into a table that is not mission critical. The engineer wants to automatically run the stored procedure on a daily basis.",
    "ask": "Which solution will meet this requirement in the MOST cost-effective way?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-103",
    "type": "single",
    "stem": "A data engineer is building a data orchestration workflow. The data engineer plans to use a hybrid model that includes some on-premises resources and some resources that are in the cloud. The data engineer wants to prioritize portability and open source resources.",
    "ask": "Which service should the data engineer use in both the on-premises environment and the cloud-based environment?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-105",
    "type": "single",
    "stem": "A data engineer creates an AWS Lambda function that an Amazon EventBridge event will invoke. When the data engineer tries to invoke the Lambda function by using an EventBridge event, an AccessDeniedException message appears.",
    "ask": "How should the data engineer resolve the exception?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-106",
    "type": "single",
    "stem": "A company uses a data lake that is based on an Amazon S3 bucket. To comply with regulations, the company must apply two layers of server-side encryption to files that are uploaded to the S3 bucket. The company wants to use an AWS Lambda function to apply the necessary encryption.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-107",
    "type": "single",
    "stem": "A data engineer notices that Amazon Athena queries are held in a queue before the queries run.",
    "ask": "How can the data engineer prevent the queries from queueing?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-109",
    "type": "single",
    "stem": "An ecommerce company wants to use AWS to migrate data pipelines from an on-premises environment into the AWS Cloud. The company currently uses a third-party tool in the on-premises environment to orchestrate data ingestion processes. The company wants a migration solution that does not require the company to manage servers. The solution must be able to orchestrate Python and Bash scripts. The solution must not require the company to refactor any code.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-112",
    "type": "single",
    "stem": "A company wants to migrate data from an Amazon RDS for PostgreSQL DB instance in the eu-east-1 Region of an AWS account named Account_A. The company will migrate the data to an Amazon Redshift cluster in the eu-west-1 Region of an AWS account named Account_B.",
    "ask": "Which solution will give AWS Database Migration Service (AWS DMS) the ability to replicate data between two data stores?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "C",
        "text": "Use an AWS Glue job to copy all the data files into one folder. Use a COPY command to load the data into Amazon Redshift."
      },
      {
        "id": "D",
  ...
  },
  {
    "id": "DEA-C01-114",
    "type": "single",
    "stem": "A company plans to use Amazon Kinesis Data Firehose to store data in Amazon S3. The source data consists of 2 MB .csv files. The company must convert the .csv files to JSON format. The company must store the files in Apache Parquet format.",
    "ask": "Which solution will meet these requirements with the LEAST development effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-115",
    "type": "single",
    "stem": "A company is using an AWS Transfer Family server to migrate data from an on-premises environment to AWS. Company policy mandates the use of TLS 1.2 or above to encrypt the data in transit.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-116",
    "type": "single",
    "stem": "A company wants to migrate an application and an on-premises Apache Kafka server to AWS. The application processes incremental updates that an on-premises Oracle database sends to the Kafka server. The company wants to use the replatform migration strategy instead of the refactor strategy.",
    "ask": "Which solution will meet these requirements with the LEAST management overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-117",
    "type": "single",
    "stem": "A data engineer is building an automated extract, transform, and load (ETL) ingestion pipeline by using AWS Glue. The pipeline ingests compressed files that are in an Amazon S3 bucket. The ingestion pipeline must support incremental data processing.",
    "ask": "Which AWS Glue feature should the data engineer use to meet this requirement?",
    "options": [
      {
        "id": "A",
        "text": "Workflows"
  ...
  },
  {
    "id": "DEA-C01-119",
    "type": "single",
    "stem": "A company stores logs in an Amazon S3 bucket. When a data engineer attempts to access several log files, the data engineer discovers that some files have been unintentionally deleted. The data engineer needs a solution that will prevent unintentional file deletion in the future.",
  ...
  },
  {
    "id": "DEA-C01-121",
    "type": "single",
    "stem": "A data engineer is processing and analyzing multiple terabytes of raw data that is in Amazon S3. The data engineer needs to clean and prepare the data. Then the data engineer needs to load the data into Amazon Redshift for analytics. The data engineer needs a solution that will give data analysts the ability to perform complex queries. The solution must eliminate the need to perform complex extract, transform, and load (ETL) processes or to manage infrastructure.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
      ...
      {
        "id": "D",
        "text": "Use AWS Glue to prepare the data. Use AWS Database Migration Service (AWS DMS) to load the data into Amazon Redshift. Use Amazon Redshift Spectrum to run queries."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    "id": "DEA-C01-123",
    "type": "single",
    "stem": "A company reads data from customer databases that run on Amazon RDS. The databases contain many inconsistent fields. For example, a customer record field that is named place_id in one database is named location_id in another database. The company needs to link customer records across different databases, even when customer record fields do not match.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
      ...
      {
        "id": "B",
        "text": "Create an AWS Glue crawler to crawl the databases. Use the FindMatches transform to find duplicate records in the data. Evaluate and tune the transform by evaluating the performance and results."
      },
      {
        "id": "C",
        "text": "Create an AWS Glue crawler to crawl the databases. Use Amazon SageMaker to construct Apache Spark ML pipelines to find duplicate records in the data."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A finance company receives data from third-party data providers and stores the data as objects in an Amazon S3 bucket. The company ran an AWS Glue crawler on the objects to create a data catalog. The AWS Glue crawler created multiple tables. However, the company expected that the crawler would create only one table. The company needs a solution that will ensure the AWS Glue crawler creates only one table.",
    "ask": "Which combination of solutions will meet this requirement?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "An application consumes messages from an Amazon Simple Queue Service (Amazon SQS) queue. The application experiences occasional downtime. As a result of the downtime, messages within the queue expire and are deleted after 1 day. The message deletions cause data loss for the application.",
    "ask": "Which solutions will minimize data loss for the application?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-127",
    "type": "single",
    "stem": "A data engineer maintains a materialized view that is based on an Amazon Redshift database. The view has a column named load_date that stores the date when each row was loaded. The data engineer needs to reclaim database storage space by deleting all the rows from the materialized view.",
    "ask": "Which command will reclaim the MOST database storage space?",
    "options": [
      {
        "id": "A",
      ...
      {
        "id": "C",
        "text": "VACUUM table_name where load_date<=current_date materializedview"
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "C",
        "text": "Use an AWS Lambda function to call the Amazon Kinesis Agent to transform the data and deliver the transformed data to OpenSearch Service."
      },
      {
        "id": "D",
  ...
  },
  {
    "id": "DEA-C01-130",
    "type": "single",
    "stem": "A company has implemented a lake house architecture in Amazon Redshift. The company needs to give users the ability to authenticate into Redshift query editor by using a third-party identity provider (IdP). A data engineer must set up the authentication mechanism.",
    "ask": "What is the first step the data engineer should take to meet this requirement?",
    "options": [
      {
        "id": "A",
      ...
      {
        "id": "C",
        "text": "Register the third-party IdP as an identity provider for AWS Secrets Manager. Configure Amazon Redshift to use Secrets Manager to manage user credentials."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "C",
        "text": "Switch the task node type from general purpose EC2 instances to compute optimized EC2 instances."
      },
      {
        "id": "D",
  ...
  },
  {
    "id": "DEA-C01-132",
    "type": "single",
    "stem": "A company uploads .csv files to an Amazon S3 bucket. The company's data platform team has set up an AWS Glue crawler to perform data discovery and to create the tables and schemas. An AWS Glue job writes processed data from the tables to an Amazon Redshift database. The AWS Glue job handles column mapping and creates the Amazon Redshift tables in the Redshift database appropriately. If the company reruns the AWS Glue job for any reason, duplicate records are introduced into the Amazon Redshift tables. The company needs a solution that will update the Redshift tables without duplicates.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-133",
    "type": "single",
    "stem": "A company is using Amazon Redshift to build a data warehouse solution. The company is loading hundreds of files into a fact table that is in a Redshift cluster. The company wants the data warehouse solution to achieve the greatest possible throughput. The solution must use cluster resources optimally when the company loads data into the fact table.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-137",
    "type": "single",
    "stem": "A data engineer has implemented data quality rules in 1,000 AWS Glue Data Catalog tables. Because of a recent change in business requirements, the data engineer must edit the data quality rules.",
    "ask": "How should the data engineer meet this requirement with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A company stores employee data in Amazon Redshift. A table named Employee uses columns named Region ID, Department ID, and Role ID as a compound sort key.",
    "ask": "Which queries will MOST increase the speed of a query by using a compound sort key of the table?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-141",
    "type": "single",
    "stem": "A data engineer uses Amazon Managed Workflows for Apache Airflow (Amazon MWAA) to run data pipelines in an AWS account. A workflow recently failed to run. The data engineer needs to use Apache Airflow logs to diagnose the failure of the workflow.",
    "ask": "Which log type should the data engineer use to diagnose the cause of the failure?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "C",
        "text": "Turn on enhanced VPC routing for the Amazon Redshift cluster. Set up an AWS Direct Connect connection and configure a connection between each data provider and the finance company's VPC."
      },
      {
        "id": "D",
  ...
  },
  {
    "id": "DEA-C01-143",
    "type": "single",
    "stem": "Files from multiple data sources arrive in an Amazon S3 bucket on a regular basis. A data engineer wants to ingest new files into Amazon Redshift in near real time when the new files arrive in the S3 bucket.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-144",
    "type": "single",
    "stem": "A technology company currently uses Amazon Kinesis Data Streams to collect log data in real time. The company wants to use Amazon Redshift for downstream real-time queries and to enrich the log data.",
    "ask": "Which solution will ingest data into Amazon Redshift with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-147",
    "type": "single",
    "stem": "A transportation company wants to track vehicle movements by capturing geolocation records. The records are 10 bytes in size. The company receives up to 10,000 records every second. Data transmission delays of a few minutes are acceptable because of unreliable network conditions. The transportation company wants to use Amazon Kinesis Data Streams to ingest the geolocation data. The company needs a reliable mechanism to send data to Kinesis Data Streams. The company needs to maximize the throughput efficiency of the Kinesis shards.",
    "ask": "Which solution will meet these requirements in the MOST operationally efficient way?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-148",
    "type": "single",
    "stem": "An investment company needs to manage and extract insights from a volume of semi-structured data that grows continuously. A data engineer needs to deduplicate the semi-structured data, remove records that are duplicates, and remove common misspellings of duplicates.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A company is building an inventory management system and an inventory reordering system to automatically reorder products. Both systems use Amazon Kinesis Data Streams. The inventory management system uses the Amazon Kinesis Producer Library (KPL) to publish data to a stream. The inventory reordering system uses the Amazon Kinesis Client Library (KCL) to consume data from the stream. The company configures the stream to scale up and down as needed. Before the company deploys the systems to production, the company discovers that the inventory reordering system received duplicated data.",
    "ask": "Which factors could have caused the reordering system to receive duplicated data?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-150",
    "type": "single",
    "stem": "An ecommerce company operates a complex order fulfilment process that spans several operational systems hosted in AWS. Each of the operational systems has a Java Database Connectivity (JDBC)-compliant relational database where the latest processing state is captured. The company needs to give an operations team the ability to track orders on an hourly basis across the entire fulfillment process.",
    ...
    "options": [
      ...
      {
        "id": "B",
        "text": "Use AWS Glue to build ingestion pipelines from the operational systems into Amazon DynamoDB. Build dashboards in Amazon QuickSight that track the orders."
      },
      {
        "id": "C",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A data engineer needs to use Amazon Neptune to develop graph applications.",
    "ask": "Which programming languages should the engineer use to develop the graph applications?",
    "options": [
      {
        "id": "A",
        "text": "Gremlin"
  ...
  },
  {
    ...
    "ask": "Which combination of steps will meet this requirement with LEAST developmental effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-154",
    "type": "single",
    "stem": "A company stores customer records in Amazon S3. The company must not delete or modify the customer record data for 7 years after each record is created. The root user also must not have the ability to delete or modify the data. A data engineer wants to use S3 Object Lock to secure the data.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-155",
    "type": "single",
    "stem": "A data engineer needs to create a new empty table in Amazon Athena that has the same schema as an existing table named old_table.",
    "ask": "Which SQL statement should the data engineer use to meet this requirement?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-156",
    "type": "single",
    "stem": "A data engineer needs to create an Amazon Athena table based on a subset of data from an existing Athena table named cities_world. The cities_world table contains cities that are located around the world. The data engineer must create a new table named cities_usa to contain only the cities from cities_world that are located in the US.",
    "ask": "Which SQL statement should the data engineer use to meet this requirement?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A company has an application that uses a microservice architecture. The company hosts the application on an Amazon Elastic Kubernetes Service (Amazon EKS) cluster. The company wants to set up a robust monitoring system for the application. The company needs to analyze the logs from the EKS cluster and the application. The company needs to correlate the cluster's logs with the application's traces to identify points of failure in the whole application request flow.",
    "ask": "Which combination of steps will meet these requirements with the LEAST development effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-160",
    "type": "single",
    "stem": "A company has a gaming application that stores data in Amazon DynamoDB tables. A data engineer needs to ingest the game data into an Amazon OpenSearch Service cluster. Data updates must occur in near real time.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-161",
    "type": "single",
    "stem": "A company uses Amazon Redshift as its data warehouse service. A data engineer needs to design a physical data model. The data engineer encounters a de-normalized table that is growing in size. The table does not have a suitable column to use as the distribution key.",
    "ask": "Which distribution style should the data engineer use to meet these requirements with the LEAST maintenance overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "B",
        "text": "Attach an IAM role to the EKS worker nodes. Grant the IAM role access to DynamoDB. Use the IAM role to set up IAM roles service accounts (IRSA) functionality."
      },
      {
        "id": "C",
      ...
      {
        "id": "D",
        "text": "Create an IAM user that has an access key to access the DynamoDB table. Use Kubernetes secrets that are mounted in a volume of the EKS cluster nodes to store the user access key data."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "C",
        "text": "Create a security group in a public subnet. Configure the security group to allow only connections from the CIDR blocks that correspond to the data producer. Create Amazon S3 buckets that contain presigned URLs that have one-day expiration dates."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A data engineer configured an AWS Glue Data Catalog for data that is stored in Amazon S3 buckets. The data engineer needs to configure the Data Catalog to receive incremental updates. The data engineer sets up event notifications for the S3 bucket and creates an Amazon Simple Queue Service (Amazon SQS) queue to receive the S3 events.",
    "ask": "Which combination of steps should the data engineer take to meet these requirements with LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-167",
    "type": "single",
    "stem": "A company uses AWS Glue Data Catalog to index data that is uploaded to an Amazon S3 bucket every day. The company uses a daily batch process in an extract, transform, and load (ETL) pipeline to upload data from external sources into the S3 bucket. The company runs a daily report on the S3 data. Some days, the company runs the report before all the daily data has been uploaded to the S3 bucket. A data engineer must be able to send a message that identifies any incomplete data to an existing Amazon Simple Notification Service (Amazon SNS) topic.",
    "ask": "Which solution will meet this requirement with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-168",
    "type": "single",
    "stem": "A company stores customer data that contains personally identifiable information (PII) in an Amazon Redshift cluster. The company's marketing, claims, and analytics teams need to be able to access the customer data. The marketing team should have access to obfuscated claim information but should have full access to customer contact information. The claims team should have access to customer information for each claim that the team processes. The analytics team should have access only to obfuscated PII data.",
    "ask": "Which solution will enforce these data access requirements with the LEAST administrative overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-169",
    "type": "single",
    "stem": "A financial company recently added more features to its mobile app. The new features required the company to create a new topic in an existing Amazon Managed Streaming for Apache Kafka (Amazon MSK) cluster. A few days after the company added the new topic, Amazon CloudWatch raised an alarm on the RootDiskUsed metric for the MSK cluster.",
    "ask": "How should the company address the CloudWatch alarm?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-170",
    "type": "single",
    "stem": "A data engineer needs to build an enterprise data catalog based on the company's Amazon S3 buckets and Amazon RDS databases. The data catalog must include storage format metadata for the data in the catalog.",
    "ask": "Which solution will meet these requirements with the LEAST effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-172",
    "type": "single",
    "stem": "A company receives a data file from a partner each day in an Amazon S3 bucket. The company uses a daily AWS Glue extract, transform, and load (ETL) pipeline to clean and transform each data file. The output of the ETL pipeline is written to a CSV file named Daily.csv in a second S3 bucket. Occasionally, the daily data file is empty or is missing values for required fields. When the file is missing data, the company can use the previous day's CSV file. A data engineer needs to ensure that the previous day's data file is overwritten only if the new daily file is complete and valid.",
    "ask": "Which solution will meet these requirements with the LEAST effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "ask": "Which solution will meet these requirements with the LEAST management effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-175",
    "type": "single",
    "stem": "A company needs a solution to manage costs for an existing Amazon DynamoDB table. The company also needs to control the size of the table. The solution must not disrupt any ongoing read or write operations. The company wants to use a solution that automatically deletes data from the table after 1 month.",
    "ask": "Which solution will meet these requirements with the LEAST ongoing maintenance?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-179",
    "type": "single",
    "stem": "A company hosts its applications on Amazon EC2 instances. The company must use SSL/TLS connections that encrypt data in transit to communicate securely with AWS infrastructure that is managed by a customer. A data engineer needs to implement a solution to simplify the generation, distribution, and rotation of digital certificates. The solution must automatically renew and deploy SSL/TLS certificates.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A retail company is using an Amazon Redshift cluster to support real-time inventory management. The company has deployed an ML model on a real-time endpoint in Amazon SageMaker. The company wants to make real-time inventory recommendations. The company also wants to make predictions about future inventory needs.",
    "ask": "Which solutions will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-185",
    "type": "single",
    "stem": "A company stores a large volume of customer records in Amazon S3. To comply with regulations, the company must be able to access new customer records immediately for the first 30 days after the records are created. The company accesses records that are older than 30 days infrequently. The company needs to cost-optimize its Amazon S3 storage.",
    "ask": "Which solution will meet these requirements MOST cost-effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-186",
    "type": "single",
    "stem": "A data engineer is using Amazon QuickSight to build a dashboard to report a company's revenue in multiple AWS Regions. The data engineer wants the dashboard to display the total revenue for a Region, regardless of the drill-down levels shown in the visual.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-188",
    "type": "single",
    "stem": "A data engineer needs to create an empty copy of an existing table in Amazon Athena to perform data processing tasks. The existing table in Athena contains 1,000 rows.",
    "ask": "Which query will meet this requirement?",
    "options": [
      {
        "id": "A",
        "text": "CREATE TABLE new_table LIKE old_table;"
      ...
      {
        "id": "D",
        "text": "CREATE TABLE new_table AS SELECT * FROM old_table WHERE 1=1;"
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    ...
    "ask": "Which combination of troubleshooting steps should the data engineer take?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-190",
    "type": "single",
    "stem": "A data engineer wants to orchestrate a set of extract, transform, and load (ETL) jobs that run on AWS. The ETL jobs contain tasks that must run Apache Spark jobs on Amazon EMR, make API calls to Salesforce, and load data into Amazon Redshift. The ETL jobs need to handle failures and retries automatically. The data engineer needs to use Python to orchestrate the jobs.",
    "ask": "Which service will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Amazon Managed Workflows for Apache Airflow (Amazon MWAA)"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "C",
        "text": "Store the custom Python scripts in a shared Amazon S3 bucket. Store a pointer to the custom scripts in environment variables."
      },
      {
        "id": "D",
        "text": "Assign the same alias to each Lambda function. Call each Lambda function by specifying the function's alias."
  ...
  },
  {
    "id": "DEA-C01-192",
    "type": "single",
    "stem": "A company stores customer data in an Amazon S3 bucket. Multiple teams in the company want to use the customer data for downstream analysis. The company needs to ensure that the teams do not have access to personally identifiable information (PII) about the customers.",
    "ask": "Which solution will meet this requirement with LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-193",
    "type": "single",
    "stem": "A company stores its processed data in an S3 bucket. The company has a strict data access policy. The company uses IAM roles to grant teams within the company different levels of access to the S3 bucket. The company wants to receive notifications when a user violates the data access policy. Each notification must include the username of the user who violated the policy.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-194",
    "type": "single",
    "stem": "A company needs to load customer data that comes from a third party into an Amazon Redshift data warehouse. The company stores order data and product data in the same data warehouse. The company wants to use the combined dataset to identify potential new customers. A data engineer notices that one of the fields in the source data includes values that are in JSON format.",
    "ask": "How should the data engineer load the JSON data into the data warehouse with the LEAST effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-195",
    "type": "single",
    "stem": "A company wants to analyze sales records that the company stores in a MySQL database. The company wants to correlate the records with sales opportunities identified by Salesforce. The company receives 2 GB of sales records every day. The company has 100 GB of identified sales opportunities. A data engineer needs to develop a process that will analyze and correlate sales records and sales opportunities. The process must run once each night.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-196",
    "type": "single",
    "stem": "A company stores server logs in an Amazon S3 bucket. The company needs to keep the logs for 1 year. The logs are not required after 1 year. A data engineer needs a solution to automatically delete logs that are older than 1 year.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-198",
    "type": "single",
    "stem": "A data engineer created a table named cloudtrail_logs in Amazon Athena to query AWS CloudTrail logs and prepare data for audits. The data engineer needs to write a query to display errors with error codes that have occurred since the beginning of 2024. The query must return the 10 most recent errors.",
    "ask": "Which query will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "select count (*) as TotalEvents, eventname, errorcode, errormessage from cloudtrail_logs where errorcode is not null and eventtime >= '2024-01-01T00:00:00Z' group by eventname, errorcode, errormessage order by TotalEvents desc limit 10;"
      },
      {
        "id": "B",
      ...
      {
        "id": "C",
        "text": "select count (*) as TotalEvents, eventname, errorcode, errormessage from cloudtrail_logs where eventtime >= '2024-01-01T00:00:00Z' group by eventname, errorcode, errormessage order by eventname asc limit 10;"
      },
      {
        "id": "D",
        "text": "select count (*) as TotalEvents, eventname, errorcode, errormessage from cloudtrail_logs where errorcode is not null and eventtime >= '2024-01-01T00:00:00Z' group by eventname, errorcode, errormessage limit 10;"
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    "id": "DEA-C01-200",
    "type": "single",
    "stem": "A company has an Amazon Redshift data warehouse that users access by using a variety of IAM roles. More than 100 users access the data warehouse every day. The company wants to control user access to the objects based on each user's job role, permissions, and how sensitive the data is.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-201",
    "type": "single",
    "stem": "A company uses Amazon DataZone as a data governance and business catalog solution. The company stores data in an Amazon S3 data lake. The company uses AWS Glue with an AWS Glue Data Catalog. A data engineer needs to publish AWS Glue Data Quality scores to the Amazon DataZone portal.",
    "ask": "Which solution will meet this requirement?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-202",
    "type": "single",
    "stem": "A company has a data warehouse in Amazon Redshift. To comply with security regulations, the company needs to log and store all user activities and connection activities for the data warehouse.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-203",
    "type": "single",
    "stem": "A company wants to migrate a data warehouse from Teradata to Amazon Redshift.",
    "ask": "Which solution will meet this requirement with the LEAST operational effort?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-205",
    "type": "single",
    "stem": "A data engineer uses Amazon Kinesis Data Streams to ingest and process records that contain user behavior data from an application every day. The data engineer notices that the data stream is experiencing throttling because hot shards receive much more data than other shards in the data stream.",
    "ask": "How should the data engineer resolve the throttling issue?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-208",
    "type": "single",
    "stem": "A company has a JSON file that contains personally identifiable information (PII) data and non-PII data. The company needs to make the data available for querying and analysis. The non-PII data must be available to everyone in the company. The PII data must be available only to a limited group of employees.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A company uses AWS Key Management Service (AWS KMS) to encrypt an Amazon Redshift cluster. The company wants to configure a cross-Region snapshot of the Redshift cluster as part of a disaster recovery (DR) strategy. A data engineer needs to use the AWS CLI to create the cross-Region snapshot.",
    "ask": "Which combination of steps will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-211",
    "type": "single",
    "stem": "A data engineer needs to optimize the performance of a data pipeline that handles retail orders. Data about the orders is ingested daily into an Amazon S3 bucket. The data engineer runs queries once each week to extract metrics from the orders data based on the order date for multiple date ranges. The data engineer needs an optimization solution that ensures the query performance will not degrade when the volume of data increases.",
    "ask": "Which solution will meet this requirement MOST cost-effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "B",
        "text": "ReferentialIntegrity \"city,state\" \"reference.{ref_city,ref_state}\" = 1.0"
      },
      {
        "id": "C",
  ...
  },
  {
    "id": "DEA-C01-214",
    "type": "single",
    "stem": "A company has several new datasets in CSV and JSON formats. A data engineer needs to make the data available to a team of data analysts who will analyze the data by using SQL queries.",
    "ask": "Which solution will meet these requirements in the MOST cost-effective way?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "ask": "Which additional steps should the data engineer perform to meet these requirements?",
    "options": [
      {
        "id": "A",
      ...
      {
        "id": "B",
        "text": "Configure the S3 bucket to send S3 event notifications to an Amazon Simple Queue Service (Amazon SQS) queue. Configure the Lambda function to process the queue."
      },
      {
        "id": "C",
  ...
  },
  {
    "id": "DEA-C01-219",
    "type": "single",
    "stem": "A company built a data lake and a data warehouse on AWS. The company wants to implement a data catalog to enhance the current data storage solutions. The company wants to have the capability to add business metadata and glossary information to the data catalog for every asset.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "D",
        "text": "Create an AWS Database Migration Service (AWS DMS) task. Specify an appropriate data schema to migrate. Specify the appropriate type of migration to use."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    "id": "DEA-C01-222",
    "type": "single",
    "stem": "A company wants to build a dimension table in an Amazon S3 bucket. The bucket contains historical data that includes 10 million records. The historical data is 1 TB in size. A data engineer needs a solution to update changes for up to 10,000 records in the base table every day.",
    "ask": "Which solution will meet this requirement with the LOWEST runtime?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A data engineer develops an AWS Glue Apache Spark ETL job to perform transformations on a dataset. When the data engineer runs the job, the job returns an error that reads, \"No space left on device.\" The data engineer needs to identify the source of the error and provide a solution.",
    "ask": "Which combination of steps will meet this requirement MOST cost-effectively?",
    "options": [
      {
        "id": "A",
      ...
      {
        "id": "D",
        "text": "Enable the --write-shuffle-files-to-s3 job parameter. Use the salting technique."
      },
      {
        "id": "E",
  ...
  },
  {
    "id": "DEA-C01-224",
    "type": "single",
    "stem": "A company has a data pipeline that uses an Amazon RDS instance, AWS Glue jobs, and an Amazon S3 bucket. The RDS instance and AWS Glue jobs run in a private subnet of a VPC and in the same security group. A user made a change to the security group that prevents the AWS Glue jobs from connecting to the RDS instance. After the change, the security group contains a single rule that allows inbound SSH traffic from a specific IP address. The company must resolve the connectivity issue.",
    "ask": "Which solution will meet this requirement?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-225",
    "type": "single",
    "stem": "A company builds a new data pipeline to process data for business intelligence reports. Users have noticed that data is missing from the reports. A data engineer needs to add a data quality check for columns that contain null values and for referential integrity at a stage before the data is added to storage.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
      ...
      {
        "id": "B",
        "text": "Use AWS Glue ETL jobs to perform a data quality evaluation transform on the data. Use an IsComplete rule on the requested columns. Use a ReferentialIntegrity rule for each join."
      },
      {
        "id": "C",
        "text": "Use AWS Glue ETL jobs to perform a SQL transform on the data to determine whether requested columns contain null values. Use a second SQL transform to check referential integrity."
      },
      {
        "id": "D",
  ...
  },
  {
    "id": "DEA-C01-226",
    "type": "single",
    "stem": "A company is setting up a data pipeline in AWS. The pipeline extracts client data from Amazon S3 buckets, performs quality checks, and transforms the data. The pipeline stores the processed data in a relational database. The company will use the processed data for future queries.",
    "ask": "Which solution will meet these requirements MOST cost-effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-227",
    "type": "single",
    "stem": "A company uses Amazon Redshift as a data warehouse solution. One of the datasets that the company stores in Amazon Redshift contains data for a vendor. Recently, the vendor asked the company to transfer the vendor's data into the vendor's Amazon S3 bucket once each week.",
    "ask": "Which solution will meet this requirement?",
    "options": [
      {
        "id": "A",
      ...
      {
        "id": "C",
        "text": "Use the Amazon Redshift data sharing feature. Set the vendor's S3 bucket as the destination. Configure the source to be a custom SQL query that selects the required data."
      },
      {
        "id": "D",
        "text": "Configure Amazon Redshift Spectrum to use the vendor's S3 bucket as a destination. Enable data querying in both directions."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    "id": "DEA-C01-228",
    "type": "single",
    "stem": "A company uses an Amazon Redshift cluster as a data warehouse that is shared across two departments. To comply with a security policy, each department must have unique access permissions. Department A must have access to tables and views for Department A. Department B must have access to tables and views for Department B. The company often runs SQL queries that use objects from both departments in one query.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-229",
    "type": "single",
    "stem": "A company wants to ingest streaming data into an Amazon Redshift data warehouse from an Amazon Managed Streaming for Apache Kafka (Amazon MSK) cluster. A data engineer needs to develop a solution that provides low data access time and that optimizes storage costs.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-230",
    "type": "single",
    "stem": "A sales company uses AWS Glue ETL to collect, process, and ingest data into an Amazon S3 bucket. The AWS Glue pipeline creates a new file in the S3 bucket every hour. File sizes vary from 200 KB to 300 KB. The company wants to build a sales prediction model by using data from the previous 5 years. The historic data includes 44,000 files. The company builds a second AWS Glue ETL pipeline by using the smallest worker type. The second pipeline retrieves the historic files from the S3 bucket and processes the files for downstream analysis. The company notices significant performance issues with the second ETL pipeline. The company needs to improve the performance of the second pipeline.",
    "ask": "Which solution will meet this requirement MOST cost-effectively?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-231",
    "type": "single",
    "stem": "A company wants to combine data from multiple software as a service (SaaS) applications for analysis. A data engineering team needs to use Amazon QuickSight to perform the analysis and build dashboards. A data engineer needs to extract the data from the SaaS applications and make the data available for QuickSight queries.",
    "ask": "Which solution will meet these requirements in the MOST operationally efficient way?",
    "options": [
      {
        "id": "A",
      ...
      {
        "id": "D",
        "text": "Export the data from the SaaS applications as Microsoft Excel files. Create a data source and a dataset in QuickSight by uploading the Excel files."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    "id": "DEA-C01-232",
    "type": "single",
    "stem": "A company runs multiple applications on AWS. The company configured each application to output logs. The company wants to query and visualize the application logs in near real time.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-233",
    "type": "single",
    "stem": "An ecommerce company processes millions of orders each day. The company uses AWS Glue ETL to collect data from multiple sources, clean the data, and store the data in an Amazon S3 bucket in CSV format by using the S3 Standard storage class. The company uses the stored data to conduct daily analysis. The company wants to optimize costs for data storage and retrieval.",
    "ask": "Which solution will meet this requirement?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-235",
    "type": "single",
    "stem": "A company manages an Amazon Redshift data warehouse. The data warehouse is in a public subnet inside a custom VPC. A security group allows only traffic from within itself. An ACL is open to all traffic. The company wants to generate several visualizations in Amazon QuickSight for an upcoming sales event. The company will run QuickSight Enterprise edition in a second AWS account inside a public subnet within a second custom VPC. The new public subnet has a security group that allows outbound traffic to the existing Redshift cluster. A data engineer needs to establish connections between Amazon Redshift and QuickSight. QuickSight must refresh dashboards by querying the Redshift cluster.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-237",
    "type": "single",
    "stem": "A data engineer needs to run a data transformation job whenever a user adds a file to an Amazon S3 bucket. The job will run for less than 1 minute. The job must send the output through an email message to the data engineer. The data engineer expects users to add one file every hour of the day.",
    "ask": "Which solution will meet these requirements in the MOST operationally efficient way?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-239",
    "type": "single",
    "stem": "A data engineer is troubleshooting an AWS Glue workflow that occasionally fails. The engineer determines that the failures are a result of data quality issues. A business reporting team needs to receive an email notification any time the workflow fails in the future.",
    "ask": "Which solution will meet this requirement?",
    "options": [
      {
        "id": "A",
      ...
      {
        "id": "D",
        "text": "Create an Amazon Simple Queue Service (Amazon SQS) standard queue. Subscribe the team's email account to the SQS queue. Create an Amazon EventBridge rule that triggers when the AWS Glue job state changes to FAILED. Set the SQS queue as the target."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    "id": "DEA-C01-240",
    "type": "single",
    "stem": "A company uses AWS Glue jobs to implement several data pipelines. The pipelines are critical to the company. The company needs to implement a monitoring mechanism that will alert stakeholders if the pipelines fail.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    "id": "DEA-C01-242",
    "type": "single",
    "stem": "A data engineer notices slow query performance on a highly partitioned table that is in Amazon Athena. The table contains daily data for the previous 5 years, partitioned by date. The data engineer wants to improve query performance and to automate partition management.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A data engineer is using an Apache Iceberg framework to build a data lake that contains 100 TB of data. The data engineer wants to run AWS Glue Apache Spark jobs that use the Iceberg framework.",
    "ask": "What combination of steps will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Create a key named --conf for an AWS Glue job. Set Iceberg as a value for the --datalake-formats job parameter."
      },
      {
        "id": "B",
        "text": "Specify the path to a specific version of Iceberg by using the --extra-jars job parameter. Set Iceberg as a value for the datalake-formats job parameter."
      },
      {
        "id": "C",
        "text": "Set Iceberg as a value for the --datalake-formats job parameter."
      },
      {
        "id": "D",
        "text": "Set the --enable-auto-scaling parameter to true."
      },
      {
        "id": "E",
        "text": "Add the --job-bookmark-option: job-bookmark-enable parameter to an AWS Glue job."
      }
    ],
    "answer": [
      "B",
  ...
  },
  {
    "id": "DEA-C01-244",
    "type": "single",
    "stem": "A data engineer is configuring an AWS Glue Apache Spark extract, transform, and load (ETL) job. The job contains a sort-merge join of two large and equally sized DataFrames. The job is failing with the following error: No space left on device.",
    "ask": "Which solution will resolve the error?",
    "options": [
      {
        "id": "A",
        "text": "Use the AWS Glue Spark shuffle manager."
      },
      {
        "id": "B",
        "text": "Deploy an Amazon Elastic Block Store (Amazon EBS) volume for the job to use."
      },
      {
        "id": "C",
        "text": "Convert the sort-merge join in the job to be a broadcast join."
      },
      {
        "id": "D",
        "text": "Convert the DataFrames to DynamicFrames, and perform a DynamicFrame join in the job."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    "id": "DEA-C01-245",
    "type": "single",
    "stem": "A company needs to implement a workflow to process transactions. Each transaction goes through multiple levels of validation. Each validation level depends on the preceding validation level. The workflow must either process or reject each transaction within 24 hours. The workflow must run for less than 24 hours total.",
    "ask": "Which solution will meet these requirements with the LEAST operational cost?",
    "options": [
      {
        "id": "A",
        "text": "Create a standard workflow in AWS Step Functions. Implement a Wait for Callback pattern to wait for the validation steps to finish."
      },
      {
        "id": "B",
        "text": "Create an express workflow in AWS Step Functions. Implement a Wait for Callback pattern to wait for the validation steps to finish."
      },
      {
        "id": "C",
        "text": "Use AWS Lambda functions to implement the workflow. Use Amazon EventBridge to invoke the validation steps."
      },
      {
        "id": "D",
        "text": "Use Amazon Managed Workflows for Apache Airflow (Amazon MWAA) to implement the workflow."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    "id": "DEA-C01-246",
    "type": "single",
    "stem": "A data engineer configures a large number of AWS Glue jobs that all start up around the same time. All the jobs run for less than 1 hour in the same subnet of the same VPC. All the AWS Glue jobs run on a G1.X worker type. Some of the jobs occasionally fail with the following error: \"The specified subnet does not have enough free addresses to satisfy the request\".",
    "ask": "What is the likely root cause of the error?",
    "options": [
      {
        "id": "A",
        "text": "There are not enough IP addresses in the subnet."
      },
      {
        "id": "B",
        "text": "The G1.X worker type cannot access the subnet."
      },
      {
        "id": "C",
        "text": "AWS Glue does not have the correct IAM permissions to add additional IP addresses to the subnet."
      },
      {
        "id": "D",
        "text": "There are not enough IP addresses in the VPC."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    "id": "DEA-C01-247",
    "type": "single",
    "stem": "A company runs an Apache Spark application every night in an Amazon EMR cluster. The company uses Amazon EC2 instances to supply compute capacity for the EMR cluster. The company deployed the Spark application in cluster mode. An error occurs in the Spark application. A log for the error is stored in the application's Spark driver standard error logs. A data engineer needs to investigate the error.",
    "ask": "Where can the data engineer find this error log?",
    "options": [
      {
        "id": "A",
        "text": "The engineer can connect to the web UI on the live cluster to see the YARN ResourceManager logs."
      },
      {
        "id": "B",
        "text": "The engineer can connect to the persistent application UI to see the first YARN container log in the Spark UI."
      },
      {
        "id": "C",
        "text": "The engineer can connect to the Amazon EMR console to see the Amazon EMR step logs that are archived in Amazon S3."
      },
      {
        "id": "D",
        "text": "The engineer can connect to the primary node of the cluster by using SSH to see the Spark history server logs."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    "id": "DEA-C01-248",
    "type": "single",
    "stem": "A company processes 500 GB of audience and advertising data daily, storing CSV files in Amazon S3 with schemas registered in AWS Glue Data Catalog. The company needs to convert these files to Apache Parquet format and store them in an S3 bucket. The solution requires a long-running workflow with 15 GiB memory capacity to process the data concurrently, followed by a correlation process that begins only after the first two processes complete.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
        "text": "Use Amazon Managed Workflows for Apache Airflow (Amazon MWAA) to orchestrate the workflow by using AWS Glue. Configure AWS Glue to begin the third process after the first two processes have finished."
      },
      {
        "id": "B",
        "text": "Use Amazon EMR to run each process in the workflow. Create an Amazon Simple Queue Service (Amazon SQS) queue to handle messages that indicate the completion of the first two processes. Configure an AWS Lambda function to process the SQS queue by running the third process."
      },
      {
        "id": "C",
        "text": "Use AWS Glue workflows to run the first two processes in parallel. Ensure that the third process starts after the first two processes have finished."
      },
      {
        "id": "D",
        "text": "Use AWS Step Functions to orchestrate a workflow that uses multiple AWS Lambda functions. Ensure that the third process starts after the first two processes have finished."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    "id": "DEA-C01-249",
    "type": "single",
    "stem": "A company uses an organization in AWS Organizations to manage multiple AWS accounts. The company uses an enhanced fanout data stream in Amazon Kinesis Data Streams to receive streaming data from multiple producers. The company runs the data stream in an account named Account A. The company wants to use an AWS Lambda function in an account named Account B to process the data from the data stream. The company creates a Lambda execution role in Account B that has permissions to access data from the data stream in Account A.",
    "ask": "What additional step must the company take to meet this requirement?",
    "options": [
      {
        "id": "A",
        "text": "Create a service control policy (SCP) to grant the data stream read access to the cross-account Lambda execution role. Attach the SCP to Account A."
      },
      {
        "id": "B",
        "text": "Add a resource-based policy to the data stream to allow read access for the cross-account Lambda execution role."
      },
      {
        "id": "C",
        "text": "Create a service control policy (SCP) to grant the data stream read access to the cross-account Lambda execution role. Attach the SCP to Account B."
      },
      {
        "id": "D",
        "text": "Add a resource-based policy to the cross-account Lambda function to grant the data stream read access to the function."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    "id": "DEA-C01-250",
    "type": "single",
    "stem": "A company needs to use Amazon Athena to analyze data that is in an Amazon S3 bucket. A data engineer needs to configure AWS Glue table partitions for year, month, and day. The data engineer needs to create the partitions every day to adjust to schema changes in the data.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Use AWS Glue DataBrew to create the partitions for the AWS Glue table."
      },
      {
        "id": "B",
        "text": "Use an AWS Lambda function to create the partitions for the AWS Glue table."
      },
      {
        "id": "C",
        "text": "Set partition projection properties for the AWS Glue table."
      },
      {
        "id": "D",
        "text": "Configure an AWS Glue crawler to run on a set schedule."
      }
    ],
    "answer": [
      "D"
  ...
  },
  {
    "id": "DEA-C01-251",
    "type": "single",
    "stem": "A hotel management company receives daily data files from each of its hotels. The company wants to upload its data to AWS. The company plans to use Amazon Athena to access the files. The company needs to protect the files from accidental deletion. The company will develop an application on its on-premises servers to automatically forward the files to a fully managed AWS ingestion service.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
        "text": "Use AWS DataSync to replicate data from the on-premises servers to Amazon Elastic File System (Amazon EFS). Configure automatic backups in AWS Backup."
      },
      {
        "id": "B",
        "text": "Use the Amazon Kinesis Agent on the on-premises servers to send data to Amazon Data Firehose. Store the data in an Amazon S3 bucket that has versioning enabled."
      },
      {
        "id": "C",
        "text": "Use AWS Glue jobs to ingest data from the on-premises servers into Amazon RDS. Enable automated backups for data protection."
      },
      {
        "id": "D",
        "text": "Use a self-managed Apache Kafka agent on the on-premises servers to stream data to Amazon Managed Streaming for Apache Kafka (Amazon MSK). Store the data in an Amazon S3 bucket with versioning enabled."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A company wants to use Apache Spark jobs that run on an Amazon EMR cluster to process streaming data. The Spark jobs will transform and store the data in an Amazon S3 bucket. The company will use Amazon Athena to perform analysis. The company needs to optimize the data format for analytical queries.",
    "ask": "Which solutions will meet these requirements with the SHORTEST query times?",
    "options": [
      {
        "id": "A",
        "text": "Use Avro format. Use AWS Glue Data Catalog to track schema changes."
      },
      {
        "id": "B",
        "text": "Use ORC format. Use AWS Glue Data Catalog to track schema changes."
      },
      {
        "id": "C",
        "text": "Use Apache Parquet format. Use an external Amazon DynamoDB table to track schema changes."
      },
      {
        "id": "D",
        "text": "Use Apache Parquet format. Use AWS Glue Data Catalog to track schema changes."
      },
      {
        "id": "E",
        "text": "Use ORC format. Store schema definitions in separate files in Amazon S3."
      }
    ],
    "answer": [
      "B",
  ...
  },
  {
    "id": "DEA-C01-253",
    "type": "single",
    "stem": "A company adds new data to a large CSV file in an Amazon S3 bucket every day. The file contains company sales data from the previous 5 years. The file currently includes more than 5,000 rows. The CSV file has the following columns: ID, SALE_DATE, ITEM_SOLD, SALE_PRICE, SALES_REP, and STORE_NAME. The company needs to use Amazon Athena to run queries on the CSV file to fetch data from a specific time period.",
    "ask": "Which solution will meet this requirement MOST cost-effectively?",
    "options": [
      {
        "id": "A",
        "text": "Write an Apache Spark script to convert the CSV data to JSON format. Create an AWS Glue job to run the script every day. Catalog the JSON data in AWS Glue. Run the Athena queries on the JSON data."
      },
      {
        "id": "B",
        "text": "Use prefixes to partition the data in the S3 bucket. Use the SALE_DATE column to create a partition for each day. Catalog the data in AWS Glue and ensure that the partitions are added. Update the Athena queries to use the new partitions."
      },
      {
        "id": "C",
        "text": "Launch an Amazon EMR cluster. Specify AWS Glue Data Catalog as the default Apache Hive metastore. Use Presto in Trino to run queries on the data."
      },
      {
        "id": "D",
        "text": "Create an Amazon RDS database. Create a table named SALES that matches the schema of the CSV file. Create an index on the SALE_DATE column. Create an AWS Lambda function to load the CSV data into the RDS database. Use S3 Event Notifications to invoke the Lambda function."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    "id": "DEA-C01-254",
    "type": "single",
    "stem": "A data engineer must implement a data cataloging solution to track schema changes in an Amazon Redshift table.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Schedule an AWS Glue crawler to run every day on the table by using the Java Database Connectivity (JDBC) driver. Configure the crawler to update an AWS Glue Data Catalog."
      },
      {
        "id": "B",
        "text": "Use AWS DataSync to log the table metadata to an AWS Glue Data Catalog. Use an AWS Glue crawler to update the Data Catalog every day."
      },
      {
        "id": "C",
        "text": "Use the AWS Schema Conversion Tool (AWS SCT) to log the table metadata to an Apache Hive metastore. Use Amazon EventBridge Scheduler to update the metastore every day."
      },
      {
        "id": "D",
        "text": "Schedule an AWS Glue crawler to run every day on the table. Configure the crawler to update an Apache Hive metastore."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    "id": "DEA-C01-255",
    "type": "single",
    "stem": "A data engineer is building a solution to detect sensitive information that is stored in a data lake across multiple Amazon S3 buckets. The solution must detect personally identifiable information (PII) that is in a proprietary data format.",
    "ask": "Which solution will meet these requirements with the LEAST operational overhead?",
    "options": [
      {
        "id": "A",
        "text": "Use the AWS Glue Detect PII transform with specific patterns."
      },
      {
        "id": "B",
        "text": "Use Amazon Macie with managed data identifiers."
      },
      {
        "id": "C",
        "text": "Use an AWS Lambda function with custom regular expressions."
      },
      {
        "id": "D",
        "text": "Use Amazon Athena with a SQL query to match the custom formats."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    "id": "DEA-C01-256",
    "type": "single",
    "stem": "A data engineer is building a new data pipeline that stores metadata in an Amazon DynamoDB table. The data engineer must ensure that all items that are older than a specified age are removed from the DynamoDB table daily.",
    "ask": "Which solution will meet this requirement with the LEAST configuration effort?",
    "options": [
      {
        "id": "A",
        "text": "Enable DynamoDB TTL on the DynamoDB table. Adjust the application source code to set the TTL attribute appropriately."
      },
      {
        "id": "B",
        "text": "Create an Amazon EventBridge rule that uses a daily cron expression to trigger an AWS Lambda function to delete items that are older than the specified age."
      },
      {
        "id": "C",
        "text": "Add a lifecycle configuration to the DynamoDB table that deletes items that are older than the specified age."
      },
      {
        "id": "D",
        "text": "Create a DynamoDB stream that has an AWS Lambda function that reacts to data modifications. Configure the Lambda function to delete items that are older than the specified age."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    "id": "DEA-C01-257",
    "type": "single",
    "stem": "A ride-sharing company stores records for all rides in an Amazon DynamoDB table. The table includes the columns RideID, RiderID, DriverID, RideStatus, TripStartTime, and TripEndTime. The table currently contains billions of items. The table is partitioned by RideID and uses TripStartTime as the sort key. The company wants to use the data to build a personal interface to give drivers the ability to view the rides that each driver has completed, based on RideStatus. The solution must access the necessary data without scanning the entire table.",
    "ask": "Which solution will meet these requirements?",
    "options": [
      {
        "id": "A",
        "text": "Create a local secondary index (LSI) on DriverID."
      },
      {
        "id": "B",
        "text": "Create a global secondary index (GSI) that uses RiderID as the partition key and RideStatus as the sort key."
      },
      {
        "id": "C",
        "text": "Create a global secondary index (GSI) that uses DriverID as the partition key and RideStatus as the sort key."
      },
      {
        "id": "D",
        "text": "Create a filter expression that uses RiderID and RideStatus."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Use the KEY distribution style for both sales tables. Select a low cardinality column to use for the join."
      },
      {
        "id": "B",
        "text": "Use the KEY distribution style for both sales tables. Select a high cardinality column to use for the join."
      },
      {
        "id": "C",
        "text": "Use the EVEN distribution style for Table S1. Use the ALL distribution style for Table S2."
      },
      {
        "id": "D",
        "text": "Use the Amazon Redshift query optimizer to review and select optimizations to implement."
      },
      {
        "id": "E",
        "text": "Use Amazon Redshift Advisor to review and select optimizations to implement."
      }
    ],
    "answer": [
      "B",
  ...
  },
  {
    ...
    "type": "multi",
    "pick": 2,
    "stem": "A gaming company uses AWS Glue to perform read and write operations on Apache Iceberg tables for real-time streaming data. The data in the Iceberg tables is in Apache Parquet format. The company is experiencing slow query performance.",
    "ask": "Which solutions will improve query performance?",
    "options": [
      {
        "id": "A",
        "text": "Use AWS Glue Data Catalog to generate column-level statistics for the Iceberg tables on a schedule."
      },
      {
        "id": "B",
        "text": "Use AWS Glue Data Catalog to automatically compact the Iceberg tables."
      },
      {
        "id": "C",
        "text": "Use AWS Glue Data Catalog to automatically optimize indexes for the Iceberg tables."
      },
      {
        "id": "D",
        "text": "Use AWS Glue Data Catalog to enable copy-on-write for the Iceberg tables."
      },
      {
        "id": "E",
        "text": "Use AWS Glue Data Catalog to generate views for the Iceberg tables."
      }
    ],
    "answer": [
      "A",
